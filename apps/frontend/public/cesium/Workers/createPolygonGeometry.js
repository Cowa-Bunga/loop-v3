define([
  ...
  function q(o) {
    ...
    if (i.st || i.normal || i.tangent || i.bitangent || l) {
      ...
      let T
      i.normal &&
        (T = x && h && !g ? s.attributes.normal.values : new Float32Array(d))
      ...
      if (0 !== P) {
        ...
        ;(Z = e.Matrix3.fromQuaternion(t, Z)),
          (t = r.Quaternion.fromAxisAngle(b._plane.normal, -P, U)),
          (J = e.Matrix3.fromQuaternion(t, J))
      } else
        (Z = e.Matrix3.clone(e.Matrix3.IDENTITY, Z)),
          (J = e.Matrix3.clone(e.Matrix3.IDENTITY, J))
      let X = 0,
        $ = 0
      h && f && ((X = d / 2), ($ = d / 3), (d /= 2))
      for (let r = 0; r < d; r += 3) {
        ...
        if (i.normal || i.tangent || i.bitangent || l) {
          ...
          if (g) {
            if (r + 3 < d) {
              ...
              e.Cartesian3.equalsEpsilon(t, a, m.CesiumMath.EPSILON10) &&
                (K = !0)
            }
            ;(i.tangent || i.bitangent) &&
              ((q = _.geodeticSurfaceNormal(a, q)),
              i.tangent &&
                (V = e.Cartesian3.normalize(e.Cartesian3.cross(q, O, V), V)))
          } else
              ...
              (i.tangent || i.bitangent) &&
                (x &&
                  ...
                  (B = e.Cartesian3.normalize(
                    e.Matrix3.multiplyByVector(J, B, B),
                    B
                  )),
                  i.bitangent &&
                    (k = e.Cartesian3.normalize(
                      e.Cartesian3.cross(S, B, k),
                      k
                    ))),
                (V = e.Cartesian3.cross(e.Cartesian3.UNIT_Z, O, V)),
                (V = e.Cartesian3.normalize(
                  e.Matrix3.multiplyByVector(J, V, V),
                  V
                )),
                i.bitangent &&
                  (q = e.Cartesian3.normalize(e.Cartesian3.cross(O, V, q), q)))
          i.normal &&
            (o.wall
              ? ((T[G + X] = O.x), (T[t + X] = O.y), (T[n + X] = O.z))
              : f && ((T[G + X] = -O.x), (T[t + X] = -O.y), (T[n + X] = -O.z)),
            ((h && !x) || g) && ((T[G] = O.x), (T[t] = O.y), (T[n] = O.z))),
            l &&
              (g && (O = _.geodeticSurfaceNormal(a, O)),
              (v[G + X] = -O.x),
              (v[t + X] = -O.y),
              (v[n + X] = -O.z)),
            i.tangent &&
              (o.wall
                ? ((I[G + X] = V.x), (I[t + X] = V.y), (I[n + X] = V.z))
                : f &&
                  ((I[G + X] = -V.x), (I[t + X] = -V.y), (I[n + X] = -V.z)),
              h &&
                (x
                  ? ((I[G] = B.x), (I[t] = B.y), (I[n] = B.z))
                  : ((I[G] = V.x), (I[t] = V.y), (I[n] = V.z)))),
            i.bitangent &&
              (f && ((A[G + X] = q.x), (A[t + X] = q.y), (A[n + X] = q.z)),
              h &&
                (x
                  ? ((A[G] = k.x), (A[t] = k.y), (A[n] = k.z))
                  : ((A[G] = q.x), (A[t] = q.y), (A[n] = q.z)))),
            (G += 3)
        }
      }
      i.st &&
        !t.defined(y) &&
        (s.attributes.st = new u.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 2,
          values: w
        })),
        i.normal &&
          (s.attributes.normal = new u.GeometryAttribute({
            componentDatatype: a.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: T
          })),
        i.tangent &&
          (s.attributes.tangent = new u.GeometryAttribute({
            componentDatatype: a.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: I
          })),
        i.bitangent &&
          (s.attributes.bitangent = new u.GeometryAttribute({
            componentDatatype: a.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: A
          })),
    ...
    if (o.extrude && t.defined(o.offsetAttribute)) {
      ...
      if (o.offsetAttribute === p.GeometryOffsetAttribute.TOP)
        (h && f) || g ? (e = e.fill(1, 0, t / 2)) : h && (e = e.fill(1))
      else {
  ...
  function $(e, i, r, a, l) {
    if (
      ((l = t.defaultValue(l, new n.Rectangle())),
      !t.defined(e) || e.length < 3)
    )
    ...
    for (let t = 1; t < c; t++)
      (p = d),
        (d = y),
        (y = i.cartesianToCartographic(e[t], p)),
        X.setEndPoints(d, y),
        et(X, u, l, J)
    return (
      (p = d),
  ...
  function et(t, e, o, i) {
    ...
    for (let e = 0; e < n; e++) {
      ...
      const r = e.longitude,
        n = e.latitude
      ;(o.west = Math.min(o.west, r)),
        (o.east = Math.max(o.east, r)),
        (o.south = Math.min(o.south, n)),
        (o.north = Math.max(o.north, n))
      const l = r >= 0 ? r : r + m.CesiumMath.TWO_PI
      ;(i.westOverIDL = Math.min(i.westOverIDL, l)),
        (i.eastOverIDL = Math.max(i.eastOverIDL, l))
    }
  }
  const ot = []
  function it(e, o, i, r, n, a, s, u, p, y) {
    ...
    let f
    if (s || u) {
      const n = g.PolygonGeometryLibrary.createGeometryFromPositions(
          e,
          o,
          i,
          r,
      ...
      if (s && u) {
        const e = l.concat(l)
        ;(b = e.length / 3),
          (_ = d.IndexDatatype.createTypedArray(b, 2 * h.length)),
          _.set(h)
        const o = h.length,
          r = b / 2
        for (f = 0; f < o; f += 3) {
        ...
        if (((n.attributes.position.values = e), a && p.normal)) {
          ...
          ;(n.attributes.normal.values = new Float32Array(e.length)),
            n.attributes.normal.values.set(t)
        }
        if (p.st && t.defined(i)) {
          const t = n.attributes.st.values
          ;(n.attributes.st.values = new Float32Array(2 * b)),
            (n.attributes.st.values = t.concat(t))
        }
        n.indices = _
      } else if (u) {
        for (
          b = l.length / 3,
            _ = d.IndexDatatype.createTypedArray(b, h.length),
            f = 0;
          f < h.length;
          f += 3
        )
  ...
  function rt(i) {
    ...
    ;(this._vertexFormat = f.VertexFormat.clone(a)),
      ...
      (this.packedLength =
        ...
        (c
          ? g.PolygonGeometryLibrary.computeHierarchyPackedLength(
              c,
              n.Cartesian2
            )
          : 1) +
  ...
  ;(rt.fromPositions = function (e) {
    return new rt({
      polygonHierarchy: {
        positions: (e = t.defaultValue(e, t.defaultValue.EMPTY_OBJECT))
          .positions
      },
      height: e.height,
    ...
    (rt.pack = function (o, i, r) {
      return (
        ...
        (r = g.PolygonGeometryLibrary.packPolygonHierarchy(
          o._polygonHierarchy,
          i,
          r,
          e.Cartesian3
  ...
  return (
    (rt.unpack = function (o, i, r) {
      ...
      const a = g.PolygonGeometryLibrary.unpackPolygonHierarchy(
        o,
        i,
        e.Cartesian3
      )
      ...
      const u = o[i++],
        ...
        C =
          -1 === o[i]
            ? void 0
            : g.PolygonGeometryLibrary.unpackPolygonHierarchy(
                o,
                i,
                n.Cartesian2
              )
    ...
    (rt.createGeometry = function (e) {
      ...
      const I = l.EllipsoidTangentPlane.fromPoints(T, i),
        A = g.PolygonGeometryLibrary.polygonsFromHierarchy(
          f,
          w,
      ...
      T = v[0].outerRing
      const O = g.PolygonGeometryLibrary.computeBoundingRectangle(
          I.plane.normal,
      ...
      if (
        ...
        !m.CesiumMath.equalsEpsilon(H, D, 0, m.CesiumMath.EPSILON2)
      )
        for (
          N.extrude = !0,
            N.top = _,
          ...
          _ && P
            ? ((e = t.topAndBottom),
              (N.geometry =
                g.PolygonGeometryLibrary.scaleToGeodeticHeightExtruded(
                  e.geometry,
                  H,
                  D,
                  i,
            ...
            : _
            ? ((e = t.topAndBottom),
              (e.geometry.attributes.position.values =
        ...
        for (F = 0; F < E.length; F++) {
          const r = new c.GeometryInstance({
            geometry: g.PolygonGeometryLibrary.createGeometryFromPositions(
              i,
              E[F],
              w ? G[F] : void 0,
              n,
      ...
      ;(R.attributes.position.values = new Float64Array(
        ...
        (R.indices = d.IndexDatatype.createTypedArray(
    ...
    function (o, i) {
      return (
        t.defined(i) && (o = rt.unpack(o, i)),
        (o._ellipsoid = e.Ellipsoid.clone(o._ellipsoid)),
        rt.createGeometry(o)
      )
    }
  )
