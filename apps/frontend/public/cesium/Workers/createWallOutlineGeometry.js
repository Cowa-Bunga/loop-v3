define([
  ...
  H.pack = function (t, n, o) {
    ...
    return (
      i.Ellipsoid.pack(t._ellipsoid, n, o),
      (n[(o += i.Ellipsoid.packedLength)] = t._granularity),
      n
    )
  }
  ...
  return (
    (H.unpack = function (t, n, o) {
      ...
      let s = t[n++]
      const r = new Array(s)
      for (a = 0; a < s; ++a, n += i.Cartesian3.packedLength)
        r[a] = i.Cartesian3.unpack(t, n)
      let l, m
      if (((s = t[n++]), s > 0))
        for (l = new Array(s), a = 0; a < s; ++a) l[a] = t[n++]
      if (((s = t[n++]), s > 0))
        for (m = new Array(s), a = 0; a < s; ++a) m[a] = t[n++]
    ...
    (H.createGeometry = function (m) {
      ...
      return (
        ...
        new o.Geometry({
          ...
          boundingSphere: new t.BoundingSphere.fromVertices(A)
        })
      )
    }),
    function (t, n) {
      return (
        e.defined(n) && (t = H.unpack(t, n)),
