define([
  ...
  function M(t, a, o, r, s, i, c) {
    ...
    ;(h = e.Matrix2.multiplyByVector(Y, h, h)),
  ...
  g.computeOptions = function (t, n, a, o, s, i, c) {
    let g,
      ...
      X = !1,
      Y = !1
    d === r.CesiumMath.PI_OVER_TWO && (X = !0),
      w === -r.CesiumMath.PI_OVER_TWO && (Y = !0)
    const m = d - w
    ...
    ;(0 === a && 0 === o) ||
      (y.longitude < R.longitude && (y.longitude += r.CesiumMath.TWO_PI),
      (C = S.project(y, C)))
    const O = G,
      P = x,
