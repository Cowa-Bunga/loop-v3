define([
  ...
  function A(e, t) {
    ...
    const E = b
    if (u)
      p.RectangleGeometryLibrary.computePosition(t, i, !1, A, 0, E),
        (y[_++] = E.x),
        (y[_++] = E.y),
        (y[_++] = E.z)
    else
      for (m = 0; m < l; m++)
        p.RectangleGeometryLibrary.computePosition(t, i, !1, A, m, E),
          (y[_++] = E.x),
          (y[_++] = E.y),
          (y[_++] = E.z)
    for (m = l - 1, A = 1; A < n; A++)
  ...
  E.unpack = function (n, o, r) {
    ...
    return e.defined(r)
      ...
      : ((P.granularity = s),
        ...
        (P.rotation = c),
        (P.extrudedHeight = p),
        (P.offsetAttribute = -1 === d ? void 0 : d),
        new E(P))
  }
  ...
  return (
    (E.createGeometry = function (t) {
      const i = t._rectangle,
        a = t._ellipsoid,
        d = p.RectangleGeometryLibrary.computeOptions(
          i,
          t._granularity,
          t._rotation,
          0,
      ...
      let f, g
      if (
        u.CesiumMath.equalsEpsilon(i.north, i.south, u.CesiumMath.EPSILON10) ||
        u.CesiumMath.equalsEpsilon(i.east, i.west, u.CesiumMath.EPSILON10)
      )
        return
        ...
        if (
          ((f = (function (e, t) {
            const i = e._surfaceHeight,
              ...
              u = t.height,
              p = t.width,
              d = c.PolygonPipeline.scaleToGeodeticHeight(
            ...
            g.set(d)
            const h = c.PolygonPipeline.scaleToGeodeticHeight(
              l.attributes.position.values,
              r,
              o
            )
          ...
          t._offsetAttribute === l.GeometryOffsetAttribute.TOP
            ? (i = i.fill(1, 0, e / 2))
            : ((E =
                t._offsetAttribute === l.GeometryOffsetAttribute.NONE ? 0 : 1),
              (i = i.fill(E))),
