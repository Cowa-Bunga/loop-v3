define([
  ...
  ;(r.packedLength = 4),
    ...
    (r.fromPoints = function (t, e) {
      ...
      return (e.x = h), (e.y = u), (e.width = d - h), (e.height = a - u), e
    })
  const u = new h.GeographicProjection(),
  ...
  ;(r.fromRectangle = function (t, n, h) {
    ...
    const o = (n = i.defaultValue(n, u)).project(e.Rectangle.southwest(t, d)),
      c = n.project(e.Rectangle.northeast(t, a))
    return (
      e.Cartesian2.subtract(c, o, c),
      (h.x = o.x),
      (h.y = o.y),
      (h.width = c.x),
      (h.height = c.y),
