define([
  ...
  ;(A.packedLength =
    2 * n.Cartesian3.packedLength + c.VertexFormat.packedLength + 7),
  ...
  ;(A.unpack = function (t, e, a) {
    ...
    (A.createGeometry = function (t) {
      ...
      g.position &&
        (ot.position = new o.GeometryAttribute({
      ...
      if (g.st || g.normal || g.tangent || g.bitangent) {
        for (P = 0; P < U; P++) {
          ...
          if ((W[P] && n.Cartesian3.negate(e, e), g.st)) {
            ...
            ;(H[st++] = Math.atan2(t.y, t.x) / l.CesiumMath.TWO_PI + 0.5),
              (H[st++] = Math.asin(e.z) / Math.PI + 0.5)
          }
          if (
            (g.normal && ((Z[mt++] = e.x), (Z[mt++] = e.y), (Z[mt++] = e.z)),
            g.tangent || g.bitangent)
          ) {
            const t = C
            let a,
              i = 0
        ...
        g.st &&
          (ot.st = new o.GeometryAttribute({
            componentDatatype: i.ComponentDatatype.FLOAT,
            componentsPerAttribute: 2,
            values: H
          })),
          g.normal &&
            (ot.normal = new o.GeometryAttribute({
              componentDatatype: i.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: Z
            })),
          g.tangent &&
            (ot.tangent = new o.GeometryAttribute({
              componentDatatype: i.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: j
            })),
          g.bitangent &&
            (ot.bitangent = new o.GeometryAttribute({
              componentDatatype: i.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: q
            }))
      ...
      if (r.defined(t._offsetAttribute)) {
        ...
        ot.applyOffset = new o.GeometryAttribute({
