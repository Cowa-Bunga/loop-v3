define([
  ...
  function w(e) {
    ...
    ;(this._ellipseGeometry = new i.EllipseGeometry(o)),
  ...
  return (
    (w.unpack = function (o, n, s) {
      ...
      return (
        ...
        (M.vertexFormat = r.VertexFormat.clone(
          l._vertexFormat,
          M.vertexFormat
        )),
        ...
        t.defined(s)
          ? ((M.semiMajorAxis = l._semiMajorAxis),
            (M.semiMinorAxis = l._semiMinorAxis),
            (s._ellipseGeometry = new i.EllipseGeometry(M)),
            s)
    ...
    function (i, r) {
      return (
        ...
        (i._ellipseGeometry._center = e.Cartesian3.clone(
          i._ellipseGeometry._center
        )),
        (i._ellipseGeometry._ellipsoid = e.Ellipsoid.clone(
