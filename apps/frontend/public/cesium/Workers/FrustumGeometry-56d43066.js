define([
  ...
  function _(t) {
    ;(t.top === t._top &&
      ...
      (t._near = t.near),
      (t._far = t.far),
      (t._orthographicMatrix = n.Matrix4.computeOrthographicOffCenter(
        t.left,
        t.right,
        t.bottom,
        t.top,
  ...
  function V(t) {
    ...
    ;(e === t._top &&
      ...
      (t._near = o),
      (t._far = s),
      (t._perspectiveMatrix = n.Matrix4.computePerspectiveOffCenter(
        r,
        i,
        a,
        e,
      ...
      (t._infinitePerspective = n.Matrix4.computeInfinitePerspectiveOffCenter(
        r,
        i,
        a,
        e,
  ...
  function T(t) {
    ...
    let u, c
    n instanceof z
      ? ((u = S), (c = z.packedLength))
      : n instanceof v && ((u = 1), (c = v.packedLength)),
      (this._frustumType = u),
  ...
  T.pack = function (t, n, i) {
    ...
    return (
      (n[i++] = o),
      o === S
        ? (z.pack(s, n, i), (i += z.packedLength))
        : (v.pack(s, n, i), (i += v.packedLength)),
  ...
  T.unpack = function (t, n, i) {
    ...
    let s
    o === S
      ? ((s = z.unpack(t, n, k)), (n += z.packedLength))
      : ((s = v.unpack(t, n, A)), (n += v.packedLength))
  ...
  ;(T._computeNearFarPlanes = function (t, e, i, o, s, f, u, l) {
    ...
    r.defined(_)
      ? ((W[0] = o.near), (W[1] = o.far))
      : ((W[0] = 0), (W[1] = o.near), (W[2] = o.far))
    for (let e = 0; e < 2; ++e)
      for (let i = 0; i < 4; ++i) {
        ...
        if (r.defined(_)) {
          ...
          const i = 1 / f.w
          a.Cartesian3.multiplyByScalar(f, i, f),
            a.Cartesian3.subtract(f, t, f),
            a.Cartesian3.normalize(f, f)
          const r = a.Cartesian3.dot(d, f)
          a.Cartesian3.multiplyByScalar(f, W[e] / r, f),
            a.Cartesian3.add(f, t, f)
        } else {
