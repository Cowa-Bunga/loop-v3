define([
  ...
  function O(t, e, i) {
    ...
    for (C = 0; C < d.length; C += 2)
      (b = d[C].length - 3), (A += b), (w += 2 * b), (_ += d[C + 1].length - 3)
    for (A += 3, _ += 3, C = 0; C < c.length; C++) {
      h = c[C]
      const t = c[C].leftPositions
      n.defined(t)
        ? ((b = t.length), (A += b), (w += b))
        : ((b = c[C].rightPositions.length), (_ += b), (w += b))
    }
    const v = n.defined(y)
    let T
    ...
    if (v) {
      ...
      const t = y[0]
      for (
        Y = r.Cartesian3.fromArray(p, 0, Y),
          W = r.Cartesian3.fromArray(f, 0, W),
          C = 0;
        C < q;
        C++
      )
    ...
    for (
      ...
      if (((Y = r.Cartesian3.fromArray(p, Z, Y)), n.defined(a))) {
        for (
          M(O, Y, W, void 0, U, e), U -= 3, l = k, u = R, t = 0;
          t < a.length / 3;
          t++
        )
        ...
        ;(m = r.Cartesian3.fromArray(D, 3 * l, m)),
          (y = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(D, 3 * u, y),
            m,
            y
          )),
          (g = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(D, 3 * (u - t), g),
            m,
            g
          )),
        ...
        for (
          M(O, Y, W, B, void 0, e), B += 3, l = R, u = k, t = 0;
          t < s.length / 3;
          t++
        )
        ...
        ;(m = r.Cartesian3.fromArray(D, 3 * l, m)),
          (y = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(D, 3 * (u + t), y),
            m,
            y
          )),
          (g = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(D, 3 * u, g),
            m,
            g
          )),
          (W = r.Cartesian3.normalize(
            r.Cartesian3.negate(r.Cartesian3.add(g, y, W), W),
            W
          )),
          M(O, Y, W, void 0, U, e),
          (U -= 3)
      ...
      for (
        ...
        (K = i.geodeticSurfaceNormal(r.Cartesian3.fromArray($, t, F), F)),
          (Q = i.geodeticSurfaceNormal(
            r.Cartesian3.fromArray(tt, b - t, N),
            N
          )),
          (Y = r.Cartesian3.normalize(r.Cartesian3.add(K, Q, Y), Y)),
          M(O, Y, W, B, U, e),
    ...
    if (
      ((Y = r.Cartesian3.fromArray(p, p.length - 3, Y)), M(O, Y, W, B, U, e), v)
    ) {
      ;(B += 3), (U -= 3), (z = V), (H = x)
      const t = y[1]
      for (C = 0; C < q; C++)
    ...
    if (
      ((g.position = new s.GeometryAttribute({
      ...
      if (v) {
        ...
        const n = T / 2
        for (C = n + 1; C < T + 1; C++)
          (o = m.CesiumMath.PI_OVER_TWO + a * C),
            (t[i++] = e * (1 + Math.cos(o))),
            (t[i++] = 0.5 * (1 + Math.sin(o)))
        for (C = 1; C < _ - T + 1; C++) (t[i++] = C * e), (t[i++] = 0)
        for (C = T; C > n; C--)
          (o = m.CesiumMath.PI_OVER_TWO - C * a),
            (t[i++] = 1 - e * (1 + Math.cos(o))),
            (t[i++] = 0.5 * (1 + Math.sin(o)))
        for (C = n; C > 0; C--)
          (o = m.CesiumMath.PI_OVER_TWO - a * C),
            (t[i++] = 1 - r * (1 + Math.cos(o))),
            (t[i++] = 0.5 * (1 + Math.sin(o)))
    ...
    return (
      e.normal &&
        (g.normal = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: O.normals
        })),
      e.tangent &&
        (g.tangent = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: O.tangents
        })),
      e.bitangent &&
        (g.bitangent = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: O.bitangents
        })),
  ...
  function S(t, e) {
    ...
    ;(C = c.PolygonPipeline.scaleToGeodeticHeight(C, y, l)),
      ...
      (g = (function (t, e) {
        ...
        ;(e.normal || e.bitangent) &&
          ((i = t.normal.values), (n = t.bitangent.values))
        ...
        if (e.normal || e.bitangent || e.tangent) {
          ...
          if (
            (e.bitangent
              ? (c.set(n), c.set(n, l), (t.bitangent.values = c))
              : (t.bitangent = void 0),
            e.tangent)
          ) {
    ...
    if (t.shadowVolume) {
      ...
      r.set(t, b),
        (r = I(t, 4 * b, r)),
        (g.extrudeDirection = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: r
        })),
    ...
    if (n.defined(t.offsetAttribute)) {
      ...
      if (t.offsetAttribute === d.GeometryOffsetAttribute.TOP)
        e = e.fill(1, 0, T).fill(1, 2 * T, 4 * T)
      else {
        const r = t.offsetAttribute === d.GeometryOffsetAttribute.NONE ? 0 : 1
        e = e.fill(r)
      }
      g.applyOffset = new s.GeometryAttribute({
  ...
  function J(t) {
    ...
    ;(this._positions = e),
      (this._ellipsoid = r.Ellipsoid.clone(
        n.defaultValue(t.ellipsoid, r.Ellipsoid.WGS84)
      )),
      (this._vertexFormat = f.VertexFormat.clone(
        n.defaultValue(t.vertexFormat, f.VertexFormat.DEFAULT)
      )),
      (this._width = a),
      ...
      (this._granularity = n.defaultValue(
        t.granularity,
  ...
  return (
    ...
    (J.computeRectangle = function (t, e) {
      ...
      return q(
        ...
        n.defaultValue(t.ellipsoid, r.Ellipsoid.WGS84),
        o,
        n.defaultValue(t.cornerType, i.CornerType.ROUNDED),
        e
      )
    }),
    (J.createGeometry = function (i) {
      ...
      if (h)
        ...
        if (
          ...
          const t =
              i._offsetAttribute === d.GeometryOffsetAttribute.NONE ? 0 : 1,
