define([
  ...
  function g(t, a, s, n, r) {
    ...
    return (
      ...
      e.Cartesian3.dot(i, o) < u &&
        (o = e.Cartesian3.multiplyByScalar(o, -1, b)),
  ...
  return i(function (i, o) {
        ...
        for (let s = 0; s < r; s++) {
          ...
          for (let s = 1; s < r; s++) {
            ...
            ;(c.longitude = t[n]),
              ...
              (l.longitude = t[r]),
              (l.latitude = a[r]),
              e.Cartographic.equals(c, l) && (i--, (o[r] = 1))
          }
          ;(n[s] = i), (d += r)
        }
        let f = 0
    ...
    for (I = 0; I < B; I++) {
      ...
      for (let i = 0; i < t; i++) {
        ...
        let c = U[L],
          d = U[L + 1]
        ;(c = n.CesiumMath.lerp(k, x, c / f)),
          (d = n.CesiumMath.lerp(k, x, d / f)),
          L++
        let u = v,
          h = S
        if (0 === i) {
    ...
    let G = {
      ...
      startFaceNormalAndVertexCornerIds:
        T.startFaceNormalAndVertexCornerIds.buffer,
    ...
    if (i.keepDecodedPositions) {
      ...
      o.push(W.buffer, t.buffer),
        (G = a.combine(G, {
          decodedPositions: W.buffer,
