define([
  ...
  ;(p.fromDimensions = function (t) {
    ...
    return new p({
      minimum: e.Cartesian3.negate(i, new e.Cartesian3()),
      maximum: i,
    ...
    (p.pack = function (t, n, i) {
      return (
        ...
        (n[i + 2 * e.Cartesian3.packedLength] = a.defaultValue(
          t._offsetAttribute,
          -1
        )),
        n
  ...
  return (
    (p.unpack = function (t, n, i) {
      ...
      return a.defined(i)
        ? ((i._min = e.Cartesian3.clone(r, i._min)),
          (i._max = e.Cartesian3.clone(u, i._max)),
    ...
    (p.createGeometry = function (o) {
      ...
      ;(p[0] = s.x),
        ...
        (p[22] = m.y),
        (p[23] = m.z),
        (f.position = new i.GeometryAttribute({
      ...
      if (a.defined(o._offsetAttribute)) {
        ...
        f.applyOffset = new i.GeometryAttribute({
