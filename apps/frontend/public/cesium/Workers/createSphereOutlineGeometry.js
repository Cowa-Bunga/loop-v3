define([
  ...
  function y(n) {
    const r = i.defaultValue(n.radius, 1),
      o = {
        radii: new e.Cartesian3(r, r, r),
        stackPartitions: n.stackPartitions,
        slicePartitions: n.slicePartitions,
        subdivisions: n.subdivisions
      }
    ;(this._ellipsoidGeometry = new t.EllipsoidOutlineGeometry(o)),
  ...
  return (
    (y.unpack = function (n, r, o) {
      ...
      return (
        ...
        i.defined(o)
          ? (e.Cartesian3.clone(s._radii, f.radii),
            (o._ellipsoidGeometry = new t.EllipsoidOutlineGeometry(f)),
            o)
