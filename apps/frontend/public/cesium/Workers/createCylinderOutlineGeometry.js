  ...
  return (
    ...
    (p.createGeometry = function (l) {
      ...
      let O,
        V = 0
      for (O = 0; O < p - 1; O++)
        (R[V++] = O), (R[V++] = O + 1), (R[V++] = O + p), (R[V++] = O + 1 + p)
      if (
        ((R[V++] = p - 1),
        (R[V++] = 0),
        (R[V++] = p + p - 1),
        ...
        for (O = 0; O < p; O += A) (R[V++] = O), (R[V++] = O + p)
      const g = new s.GeometryAttributes()
      ;(g.position = new a.GeometryAttribute({
