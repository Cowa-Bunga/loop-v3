      ...
      if (A)
        (_.extrudedHeight = y),
          ...
          (b = (function (e) {
            const p = e.center,
              h = e.ellipsoid,
              y = e.semiMajorAxis
            let A = i.Cartesian3.multiplyByScalar(
              h.geodeticSurfaceNormal(p, c),
              e.height,
              c
            )
            ;(f.center = i.Cartesian3.add(p, A, f.center)),
              (f.radius = y),
              (A = i.Cartesian3.multiplyByScalar(
                h.geodeticSurfaceNormal(p, A),
                e.extrudedHeight,
                A
              )),
              (m.center = i.Cartesian3.add(p, A, m.center)),
              (m.radius = y)
            let _ = o.EllipseGeometryLibrary.computeEllipsePositions(
              e,
              !1,
              !0
            ).outerPositions
            ...
            if (n.defined(e.offsetAttribute)) {
              ...
              b.applyOffset = new a.GeometryAttribute({
        ...
        ((b = (function (e) {
          ...
          ;(p = i.Cartesian3.multiplyByScalar(
            e.ellipsoid.geodeticSurfaceNormal(n, p),
            e.height,
            p
          )),
            (p = i.Cartesian3.add(n, p, p))
          const l = new t.BoundingSphere(p, e.semiMajorAxis),
            d = o.EllipseGeometryLibrary.computeEllipsePositions(
              e,
              !1,
              !0
            ).outerPositions,
