define([
  ...
  'use strict'
  function L(i) {
    const n = (i = e.defaultValue(i, e.defaultValue.EMPTY_OBJECT))
        .polylinePositions,
      o = i.shapePositions
    ;(this._positions = n),
      (this._shape = o),
      (this._ellipsoid = t.Ellipsoid.clone(
        e.defaultValue(i.ellipsoid, t.Ellipsoid.WGS84)
      )),
    ...
    ;(a += 1 + o.length * r.Cartesian2.packedLength),
      (this.packedLength = a + t.Ellipsoid.packedLength + 2)
  }
  L.pack = function (i, n, o) {
    ...
    let s = l.length
    for (n[o++] = s, a = 0; a < s; ++a, o += t.Cartesian3.packedLength)
      t.Cartesian3.pack(l[a], n, o)
    const p = i._shape
    for (
      s = p.length, n[o++] = s, a = 0;
      a < s;
      ++a, o += r.Cartesian2.packedLength
    )
      r.Cartesian2.pack(p[a], n, o)
    return (
  ...
  L.unpack = function (i, n, o) {
    ...
    let l = i[n++]
    const s = new Array(l)
    for (a = 0; a < l; ++a, n += t.Cartesian3.packedLength)
      s[a] = t.Cartesian3.unpack(i, n)
    l = i[n++]
    const p = new Array(l)
    for (a = 0; a < l; ++a, n += r.Cartesian2.packedLength)
      p[a] = r.Cartesian2.unpack(i, n)
  ...
  return (
    (L.createGeometry = function (e) {
      ...
      return (function (e, t) {
        ...
        i.position = new s.GeometryAttribute({
        ...
        for (
          u[g++] = n - 1 + h, u[g++] = h, d = l - 1, h = d * n, y = 0;
          y < n - 1;
          y++
        )
          (u[g++] = y + h), (u[g++] = y + h + 1)
