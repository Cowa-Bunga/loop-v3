define([
  ...
  function G(t, i, o, s, c) {
    ...
    for (let t = 0; t < l; ++t) {
      ...
      for (let e = 0; e < v; e += 3) {
        ...
        d.Matrix4.multiplyByPoint(s, t, t),
          n.Cartesian3.subtract(t, B, t),
          n.Cartesian3.pack(t, h, 3 * w + e),
          (p[A++] = l)
      }
      const E = u.length
  ...
  return c(function (e, r) {
    ...
    !(function (e) {
      ...
      let r = 0
      n.Cartesian3.unpack(t, r, S),
        (r += n.Cartesian3.packedLength),
        d.Matrix4.unpack(t, r, V)
    })(e.packedBuffer)
    const z = {
