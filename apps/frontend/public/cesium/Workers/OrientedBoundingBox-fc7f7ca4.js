define([
  ...
  'use strict'
  function C(a, t) {
    ;(this.center = n.Cartesian3.clone(r.defaultValue(a, n.Cartesian3.ZERO))),
      (this.halfAxes = n.Matrix3.clone(r.defaultValue(t, n.Matrix3.ZERO)))
  }
  ;(C.packedLength = n.Cartesian3.packedLength + n.Matrix3.packedLength),
    (C.pack = function (a, t, e) {
      return (
        (e = r.defaultValue(e, 0)),
        n.Cartesian3.pack(a.center, t, e),
        n.Matrix3.pack(a.halfAxes, t, e + n.Cartesian3.packedLength),
        t
      )
    }),
  ...
  C.fromPoints = function (a, t) {
    if ((r.defined(t) || (t = new C()), !r.defined(a) || 0 === a.length))
      return (t.halfAxes = n.Matrix3.ZERO), (t.center = n.Cartesian3.ZERO), t
    let e
    const i = a.length,
    ...
    return (
      ...
      (_.y = S - z),
      (_.z = U - B),
      n.Cartesian3.multiplyByScalar(_, 0.5, _),
      n.Matrix3.multiplyByScale(t.halfAxes, _, t.halfAxes),
      t
    )
  }
  ...
  function w(a, t, e, i, s, o, c, u, l, d, h) {
    r.defined(h) || (h = new C())
    const x = h.halfAxes
    n.Matrix3.setColumn(x, 0, t, x),
      n.Matrix3.setColumn(x, 1, e, x),
      n.Matrix3.setColumn(x, 2, i, x)
    let m = f
    ...
    const w = h.center
    return (
      (m = n.Matrix3.multiplyByVector(x, m, m)),
      n.Cartesian3.add(a, m, w),
      n.Matrix3.multiplyByScale(x, M, x),
      h
    )
  }
  ...
  ;(C.fromRectangle = function (a, t, C, c, u) {
    ...
    if (
      ((t = r.defaultValue(t, 0)),
      (C = r.defaultValue(C, 0)),
      (c = r.defaultValue(c, n.Ellipsoid.WGS84)),
      ...
      return (
        ...
        (m = Math.min(
          o.Plane.getPointDistance(f, v),
          o.Plane.getPointDistance(f, G)
        )),
        (M = C),
    ...
    H.z = 0
    const J =
        Math.abs(H.x) < s.CesiumMath.EPSILON10 &&
        Math.abs(H.y) < s.CesiumMath.EPSILON10
          ? n.Cartesian3.UNIT_X
          : n.Cartesian3.normalize(H, k),
    ...
    return (
      (m = o.Plane.getPointDistance(f, aa)),
      (M = 0),
      w(H, Q, K, J, l, d, h, x, m, M, u)
    )
  }),
      ...
      if (r.defined(a))
        return r.defined(t)
          ? (n.Cartesian3.clone(a.center, t.center),
            n.Matrix3.clone(a.halfAxes, t.halfAxes),
            t)
    ...
    (C.intersectPlane = function (a, e) {
      const r = a.center,
        ...
        u =
          Math.abs(
            o * s[n.Matrix3.COLUMN0ROW0] +
              C * s[n.Matrix3.COLUMN0ROW1] +
              c * s[n.Matrix3.COLUMN0ROW2]
          ) +
          Math.abs(
            o * s[n.Matrix3.COLUMN1ROW0] +
              C * s[n.Matrix3.COLUMN1ROW1] +
              c * s[n.Matrix3.COLUMN1ROW2]
          ) +
          Math.abs(
            o * s[n.Matrix3.COLUMN2ROW0] +
              C * s[n.Matrix3.COLUMN2ROW1] +
              c * s[n.Matrix3.COLUMN2ROW2]
          ),
  ...
  C.distanceSquaredTo = function (a, t) {
    ...
    if (1 === m) {
      ...
      3 === m &&
        ((i = n.Cartesian3.UNIT_X),
        (o = n.Cartesian3.UNIT_Y),
        (C = n.Cartesian3.UNIT_Z))
    const g = K
    ;(g.x = n.Cartesian3.dot(e, i)),
      (g.y = n.Cartesian3.dot(e, o)),
      (g.z = n.Cartesian3.dot(e, C))
    let y,
      b = 0
    return (
      g.x < -c
    ...
    (C.equals = function (a, t) {
      return (
        ...
        (r.defined(a) &&
          ...
          n.Matrix3.equals(a.halfAxes, t.halfAxes))
      )
    }),
