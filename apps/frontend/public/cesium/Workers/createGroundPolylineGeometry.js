define([
  ...
  function w(i) {
    ;(i = n.defaultValue(i, n.defaultValue.EMPTY_OBJECT)),
      ...
      (this._numberOfLevelZeroTilesX = n.defaultValue(
        i.numberOfLevelZeroTilesX,
        2
      )),
      (this._numberOfLevelZeroTilesY = n.defaultValue(
        i.numberOfLevelZeroTilesY,
        1
      ))
  }
  Object.defineProperties(w.prototype, {
    ...
    (w.prototype.rectangleToNativeRectangle = function (e, a) {
      ...
      return n.defined(a)
        ? ((a.west = r), (a.south = s), (a.east = o), (a.north = l), a)
    ...
    (w.prototype.tileXYToRectangle = function (e, a, i, r) {
      const s = this._rectangle,
        ...
        d = s.north - (a + 1) * p
      return (
        n.defined(r) || (r = new t.Rectangle(u, d, C, h)),
        (r.west = u),
        (r.south = d),
        (r.east = C),
        (r.north = h),
    ...
    (w.prototype.positionToTileXY = function (e, a, r) {
      ...
      return (
        h >= l && (h = l - 1),
        n.defined(r) ? ((r.x = p), (r.y = h), r) : new t.Cartesian2(p, h)
      )
    })
  ...
  ;(k.initialize = function () {
    ...
    (k.getMinimumMaximumHeights = function (e, i) {
      ...
      return (
        (s = Math.max(k._defaultMinTerrainHeight, s)),
        { minimumTerrainHeight: s, maximumTerrainHeight: o }
      )
    }),
    (k.getBoundingSphere = function (t, i) {
      ...
      return (
        e.BoundingSphere.fromRectangle3D(t, i, s, O),
        e.BoundingSphere.union(o, O, o)
      )
    }),
  ...
  function X(e, t, n, i, s, o, u, C, p, h, d) {
    if (0 === s) return
    let g
    o === r.ArcType.GEODESIC
      ? (g = new l.EllipsoidGeodesic(e, t, u))
      : o === r.ArcType.RHUMB && (g = new c.EllipsoidRhumbLine(e, t, u))
    ...
    for (let e = 0; e < T; e++) {
      const e = g.interpolateUsingSurfaceDistance(M, G),
        t = U(u, e, n, Y),
        r = U(u, e, i, F)
      a.Cartesian3.pack(m, C, E),
        a.Cartesian3.pack(t, p, E),
        a.Cartesian3.pack(r, h, E),
        d.push(e.latitude),
        d.push(e.longitude),
        (E += 3),
        (M += y)
  ...
  function U(e, t, n, i) {
    return (
      a.Cartographic.clone(t, W),
      (W.height = n),
      a.Cartographic.toCartesian(W, e, i)
    )
  }
  function Z(e, t, n) {
  ...
  function $(e, t, n, i) {
    return (
      (i = Z(e, t, i)),
      (i = a.Cartesian3.cross(i, n, i)),
      (i = a.Cartesian3.normalize(i, i)),
      (i = a.Cartesian3.cross(n, i, i))
    )
  }
  ...
  function te(e, t, n, r, s) {
    const o = Z(n, t, ee),
      ...
      c = $(r, t, o, Q)
    if (
      i.CesiumMath.equalsEpsilon(
        a.Cartesian3.dot(l, c),
        -1,
        i.CesiumMath.EPSILON5
      )
    )
      return (
        (s = a.Cartesian3.cross(o, l, s)), (s = a.Cartesian3.normalize(s, s))
      )
  ...
  z.createGeometry = function (l) {
    ...
    if (
      ((B = s.arrayRemoveDuplicates(B, a.Cartographic.equalsEpsilon)),
      (j = B.length),
      j < 2)
    )
      return
    ...
    if (
      ...
      for (
        X(he, ee, y, M, f, m, g, Y, F, q, G), T = Y.length, E = 0;
        E < 3;
        ++E
      )
        (Y[T + E] = Y[E]), (F[T + E] = F[E]), (q[T + E] = q[E])
    ...
    return (function (n, r, s, l, c, p, h) {
      ...
      let V,
        G = 0
      for (g = 3, d = 1; d < B; d++)
        (H = a.Cartesian3.clone(j, H)),
          (j = a.Cartesian3.unpack(l, g, j)),
          (G += a.Cartesian3.distance(H, j)),
          (g += 3)
      g = 3
      let Y = 0,
        F = 0,
      ...
      if (n) {
        ge(J, a.Cartesian3.unpack(s, s.length - 6, Se), U, $) &&
          (J = a.Cartesian3.negate(J, J))
      }
      let Q = 0,
        K = 0,
        ee = 0
      for (d = 0; d < m; d++) {
        ...
        if (
          ...
          ;(t.y = Math.abs(t.y)),
            ...
            0 === e || a.Cartesian3.dot(t, a.Cartesian3.UNIT_Y) > N
              ...
              ? ((m = ye(r, z, J, C, Ye)),
                (d.x = 0),
                (d.y = i.CesiumMath.sign(v.longitude - Math.abs(z.longitude))),
                (d.z = 0))
              : ((d = ye(r, v, w, o, Ge)),
                (m.x = 0),
                (m.y = i.CesiumMath.sign(v.longitude - z.longitude)),
                (m.z = 0))
        }
        ...
        a.Cartesian3.add(Ce, Te, Ce),
          ...
          (Te = a.Cartesian3.multiplyByScalar(
            j,
            -2 * i.CesiumMath.EPSILON5,
            et
          )),
          a.Cartesian3.add(Ce, Te, Ce),
          a.Cartesian3.add(pe, Te, pe),
      ...
      const ae = tt
      e.BoundingSphere.fromVertices(s, a.Cartesian3.ZERO, 3, ae[0]),
        e.BoundingSphere.fromVertices(l, a.Cartesian3.ZERO, 3, ae[1])
  ...
  function ye(e, t, n, r, s) {
    ...
    Math.abs(t.longitude - C.longitude) > i.CesiumMath.PI_OVER_TWO &&
      ((c = !0),
      (l = a.Cartesian3.subtract(o, n, we)),
      (C = u.cartesianToCartographic(l, fe))),
      (C.height = 0)
    const p = e.project(C, s)
    return (
      ((s = a.Cartesian3.subtract(p, r, s)).z = 0),
      (s = a.Cartesian3.normalize(s, s)),
      c && a.Cartesian3.negate(s, s),
      s
    )
  }
  ...
  function Oe(e, t) {
    ...
    i.CesiumMath.equalsEpsilon(n, 0, i.CesiumMath.EPSILON2)
      ? ((s = Z(t, e, s)),
        a.Cartesian3.multiplyByScalar(s, i.CesiumMath.EPSILON2, s),
        a.Cartesian3.add(e, s, e))
      : i.CesiumMath.equalsEpsilon(r, 0, i.CesiumMath.EPSILON2) &&
        ((s = Z(e, t, s)),
        a.Cartesian3.multiplyByScalar(s, i.CesiumMath.EPSILON2, s),
        a.Cartesian3.add(t, s, t))
  }
  function Pe(e, t) {
    const a = Math.abs(e.longitude),
      n = Math.abs(t.longitude)
    if (
      i.CesiumMath.equalsEpsilon(a, i.CesiumMath.PI, i.CesiumMath.EPSILON11)
    ) {
      const n = i.CesiumMath.sign(t.longitude)
      return (e.longitude = n * (a - i.CesiumMath.EPSILON11)), 1
    }
    if (
      i.CesiumMath.equalsEpsilon(n, i.CesiumMath.PI, i.CesiumMath.EPSILON11)
    ) {
