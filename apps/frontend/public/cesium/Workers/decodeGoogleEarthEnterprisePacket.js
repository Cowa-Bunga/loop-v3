define([
    ...
    for (; d < h; )
      for (b = (b + 8) % 24, w = b; d < h && w < u; )
        s.setUint32(d, s.getUint32(d, !0) ^ c.getUint32(w, !0), !0),
          s.setUint32(
            d + 4,
            s.getUint32(d + 4, !0) ^ c.getUint32(w + 4, !0),
            !0
          ),
          (d += 8),
          (w += 24)
    if (d < f)
      for (w >= u && ((b = (b + 8) % 24), (w = b)); d < f; )
        s.setUint8(d, s.getUint8(d) ^ c.getUint8(w)), d++, w++
  }
  function o(e, t) {
    return 0 != (e & t)
  }
  ...
  const y = f,
    ...
    x = (e, t, n, i, r, a, o, s) => {
      ...
      for (v = 1; v < E && 0 === D[v]; v++);
      for (x < v && (x = v), T = 1, p = 1; p <= b; p++)
        if (((T <<= 1), (T -= D[p]), T < 0)) return -1
      ...
      for (;;) {
        ...
        if (p > x && (S & h) !== f) {
          for (
            0 === A && (A = x), u += v, R = p - A, T = 1 << R;
            R + A < E && ((T -= D[R + A]), !(T <= 0));

          )
            R++, (T <<= 1)
          if (((U += 1 << R), (1 === e && U > 852) || (2 === e && U > 592)))
            return 1
          ;(f = S & h), (r[f] = (x << 24) | (R << 16) | (u - a) | 0)
        }
      }
      return (
        0 !== S && (r[u + S] = ((p - A) << 24) | (64 << 16) | 0),
        (s.bits = x),
        0
      )
    },
  ...
  const te = (e) => {
      if (ee) {
        ...
        for (x(1, e.lens, 0, 288, J, 0, e.work, { bits: 9 }), t = 0; t < 32; )
          e.lens[t++] = 5
  ...
  ;(d.inflateReset = W),
    ...
    (d.inflate = (e, t) => {
      ...
      e: for (;;)
        switch (n.mode) {
              ...
              do {
                ;(Q = i[a + u++]),
                  n.head &&
                    Q &&
                    n.length < 65536 &&
                    (n.head.name += String.fromCharCode(Q))
              } while (Q && u < s)
              if (
                (512 & n.flags && 4 & n.wrap && (n.check = v(n.check, i, u, a)),
                (s -= u),
          ...
          case 16193:
            ...
            if (
              ((n.length = 65535 & c), (c = 0), (d = 0), (n.mode = P), t === T)
            )
              break e
          case P:
            n.mode = 16195
          ...
          case 16198:
            ...
            if (
              ((n.lenbits = 9),
              (J = { bits: n.lenbits }),
              (W = x(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, J)),
              (n.lenbits = J.bits),
              W)
            ) {
          ...
          case V:
            ...
            if (
              ((c >>>= m), (d -= m), (n.back += m), (n.length = k), 0 === g)
            ) {
              n.mode = 16205
              break
            }
      ...
      return (
        ...
        (n.bits = d),
        (n.wsize ||
          (h !== e.avail_out && n.mode < j && (n.mode < H || t !== R))) &&
          ne(e, e.output, e.next_out, h - e.avail_out),
        (f -= e.avail_in),
        (h -= e.avail_out),
        (e.total_in += f),
        (e.total_out += h),
        ...
        4 & n.wrap &&
          ...
          (e.adler = n.check =
            n.flags
              ? v(n.check, r, h, e.next_out - h)
              : y(n.check, r, h, e.next_out - h)),
        (e.data_type =
          n.bits +
          (n.last ? 64 : 0) +
          (n.mode === L ? 128 : 0) +
          (n.mode === z || n.mode === P ? 256 : 0)),
        ((0 === f && 0 === h) || t === R) && W === U && (W = B),
        W
      )
    }),
      ...
      return G(e)
        ...
        : ((i = e.state),
          0 !== i.wrap && i.mode !== M
            ...
            ? I
            : ((a = ne(e, t, n, n)),
              a ? ((i.mode = 16210), O) : ((i.havedict = 1), U)))
    }),
    ...
    if (
      ...
      t.dictionary &&
        ('string' == typeof t.dictionary
          ...
          : '[object ArrayBuffer]' === we.call(t.dictionary) &&
            (t.dictionary = new Uint8Array(t.dictionary)),
        t.raw &&
          ((n = le.inflateSetDictionary(this.strm, t.dictionary)), n !== ge)))
    )
  ...
  ;(Ee.prototype.push = function (e, t) {
    ...
    for (
      ...
      for (
        0 === n.avail_out &&
          ((n.output = new Uint8Array(i)), (n.next_out = 0), (n.avail_out = i)),
          a = le.inflate(n, o),
          a === _e &&
            r &&
            ((a = le.inflateSetDictionary(n, r)),
            a === ge ? (a = le.inflate(n, o)) : a === ye && (a = _e));
      ...
      if (a !== ge || 0 !== s) {
        if (a === ke)
          return (
            (a = le.inflateEnd(this.strm)), this.onEnd(a), (this.ended = !0), !0
          )
