define([
  ...
  function l(n) {
    ...
    i instanceof a.PerspectiveFrustum
      ...
      : i instanceof a.OrthographicFrustum &&
        ((c = g), (p = a.OrthographicFrustum.packedLength)),
      (this._frustumType = c),
      ...
      (this.packedLength =
        2 + p + r.Cartesian3.packedLength + t.Quaternion.packedLength)
  }
  l.pack = function (n, i, u) {
    ...
    return (
      (i[u++] = o),
      o === f
        ? (a.PerspectiveFrustum.pack(s, i, u),
          (u += a.PerspectiveFrustum.packedLength))
        : (a.OrthographicFrustum.pack(s, i, u),
          (u += a.OrthographicFrustum.packedLength)),
  ...
  return (
    (l.unpack = function (n, i, u) {
      ...
      let s
      o === f
        ? ((s = a.PerspectiveFrustum.unpack(n, i, _)),
          (i += a.PerspectiveFrustum.packedLength))
        : ((s = a.OrthographicFrustum.unpack(n, i, k)),
          (i += a.OrthographicFrustum.packedLength))
