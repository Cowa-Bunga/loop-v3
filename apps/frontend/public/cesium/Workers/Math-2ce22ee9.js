define(['exports', './defaultValue-f6d5e6da'], function (t, n) {
  ...
  ;(i.prototype.init_seed = function (t) {
    ...
    (i.prototype.init_by_array = function (t, n) {
      var i, e, r
      for (
        this.init_seed(19650218), i = 1, e = 0, r = this.N > n ? this.N : n;
        r;
        r--
      ) {
    ...
    (i.prototype.random_int = function () {
      ...
      if (this.mti >= this.N) {
        var i
        for (
          this.mti == this.N + 1 && this.init_seed(5489), i = 0;
          i < this.N - this.M;
          i++
        )
          (t =
            (this.mt[i] & this.UPPER_MASK) |
            (this.mt[i + 1] & this.LOWER_MASK)),
            (this.mt[i] = this.mt[i + this.M] ^ (t >>> 1) ^ n[1 & t])
        for (; i < this.N - 1; i++)
          (t =
            (this.mt[i] & this.UPPER_MASK) |
            (this.mt[i + 1] & this.LOWER_MASK)),
  ...
  ;(r.sign = n.defaultValue(Math.sign, function (t) {
    ...
    (r.toSNorm = function (t, i) {
      return (
        (i = n.defaultValue(i, 255)),
        Math.round((0.5 * r.clamp(t, -1, 1) + 0.5) * i)
      )
    }),
    ...
    (r.zeroToTwoPi = function (t) {
      ...
      return Math.abs(n) < r.EPSILON14 && Math.abs(t) > r.EPSILON14
        ? r.TWO_PI
        : n
    }),
    (r.mod = function (t, n) {
      return r.sign(t) === r.sign(n) && Math.abs(t) < Math.abs(n)
        ? t
        : ((t % n) + n) % n
    }),
  ...
  ;(r.setRandomNumberSeed = function (t) {
    ...
    (r.fastApproximateAtan2 = function (t, n) {
      ...
      const s = i / a
      return (
        (e = r.fastApproximateAtan(s)),
        (e = Math.abs(n) > Math.abs(t) ? r.PI_OVER_TWO - e : e),
        (e = t < 0 ? r.PI - e : e),
        (e = n < 0 ? -e : e),
        e
      )
