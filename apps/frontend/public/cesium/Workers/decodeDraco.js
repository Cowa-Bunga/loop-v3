define([
  ...
  function c(r, n, o) {
    ...
    if (c.InitFromAttribute(o)) {
      ...
      u = {
        quantizationBits: c.quantization_bits(),
        minValues: t,
        range: c.range(),
        octEncoded: !1
      }
    ...
    s.destroy(c),
      ...
      c.InitFromAttribute(o) &&
        (u = { quantizationBits: c.quantization_bits(), octEncoded: !0 }),
      s.destroy(c)
    const d = a * i
    let y
    y = e.defined(u)
      ...
      : (function (t, e, r, n) {
          ...
          switch (r.data_type()) {
            case 1:
            case 11:
              ;(a = new s.DracoInt8Array()),
                (o = new Int8Array(n)),
                e.GetAttributeInt8ForAllPoints(t, r, a)
              break
            case 2:
              ;(a = new s.DracoUInt8Array()),
                (o = new Uint8Array(n)),
                e.GetAttributeUInt8ForAllPoints(t, r, a)
              break
            case 3:
              ;(a = new s.DracoInt16Array()),
                (o = new Int16Array(n)),
                e.GetAttributeInt16ForAllPoints(t, r, a)
              break
            case 4:
              ;(a = new s.DracoUInt16Array()),
                (o = new Uint16Array(n)),
                e.GetAttributeUInt16ForAllPoints(t, r, a)
              break
            case 5:
            case 7:
              ;(a = new s.DracoInt32Array()),
                (o = new Int32Array(n)),
                e.GetAttributeInt32ForAllPoints(t, r, a)
              break
            case 6:
            case 8:
              ;(a = new s.DracoUInt32Array()),
                (o = new Uint32Array(n)),
                e.GetAttributeUInt32ForAllPoints(t, r, a)
              break
            case 9:
            case 10:
              ;(a = new s.DracoFloat32Array()),
                (o = new Float32Array(n)),
                e.GetAttributeFloatForAllPoints(t, r, a)
          }
    ...
    return e.defined(t.bufferView)
      ? (function (t) {
          ...
          if (t.dequantizeInShader)
            for (let t = 0; t < r.length; ++t) e.SkipAttributeTransform(s[r[t]])
          const o = t.bufferView,
            a = new s.DecoderBuffer()
          if (
            (a.Init(t.array, o.byteLength),
            e.GetEncodedGeometryType(a) !== s.TRIANGULAR_MESH)
          )
          ...
          if (!d.ok() || 0 === i.ptr)
            throw new n.RuntimeError(
              `Error decoding draco mesh geometry: ${d.error_msg()}`
            )
          s.destroy(a)
          const y = {},
      ...
      : (function (t) {
          ...
          t.dequantizeInShader &&
            (e.SkipAttributeTransform(s.POSITION),
            e.SkipAttributeTransform(s.NORMAL))
          const r = new s.DecoderBuffer()
          if (
            (r.Init(t.buffer, t.buffer.length),
            e.GetEncodedGeometryType(r) !== s.POINT_CLOUD)
          )
