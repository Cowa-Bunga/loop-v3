define([
  ...
  function G(e) {
    ...
    ;(this._ellipseGeometry = new t.EllipseOutlineGeometry(l)),
  ...
  const _ = new t.EllipseOutlineGeometry({
  ...
  return (
    (G.unpack = function (r, l, n) {
      ...
      return (
        ...
        i.defined(n)
          ? ((f.semiMajorAxis = o._semiMajorAxis),
            (f.semiMinorAxis = o._semiMinorAxis),
            (n._ellipseGeometry = new t.EllipseOutlineGeometry(f)),
            n)
    ...
    function (t, r) {
      return (
        ...
        (t._ellipseGeometry._center = e.Cartesian3.clone(
          t._ellipseGeometry._center
        )),
        (t._ellipseGeometry._ellipsoid = e.Ellipsoid.clone(
