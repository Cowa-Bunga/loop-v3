define([
  ...
  function A(n) {
    ...
    ;(this._positions = o),
      ...
      (this._vertexFormat = y.VertexFormat.clone(
        e.defaultValue(n.vertexFormat, y.VertexFormat.DEFAULT)
      )),
      (this._granularity = e.defaultValue(
        n.granularity,
        d.CesiumMath.RADIANS_PER_DEGREE
      )),
      (this._workerName = 'createPolylineVolumeGeometry')
    let a = 1 + o.length * t.Cartesian3.packedLength
    ;(a += 1 + i.length * r.Cartesian2.packedLength),
      (this.packedLength =
        a + t.Ellipsoid.packedLength + y.VertexFormat.packedLength + 2)
  }
  A.pack = function (n, o, i) {
    ...
    let s = l.length
    for (o[i++] = s, a = 0; a < s; ++a, i += t.Cartesian3.packedLength)
      t.Cartesian3.pack(l[a], o, i)
    const p = n._shape
    for (
      s = p.length, o[i++] = s, a = 0;
      a < s;
      ++a, i += r.Cartesian2.packedLength
    )
      r.Cartesian2.pack(p[a], o, i)
    return (
  ...
  A.unpack = function (n, o, i) {
    ...
    let l = n[o++]
    const s = new Array(l)
    for (a = 0; a < l; ++a, o += t.Cartesian3.packedLength)
      s[a] = t.Cartesian3.unpack(n, o)
    l = n[o++]
    const p = new Array(l)
    for (a = 0; a < l; ++a, o += r.Cartesian2.packedLength)
      p[a] = r.Cartesian2.unpack(n, o)
  ...
  return (
    (A.createGeometry = function (e) {
      ...
      if (
        ...
        d.length < 2 || y.length < 3)
      )
        return
      m.PolygonPipeline.computeWindingOrder2D(y) === m.WindingOrder.CLOCKWISE &&
        y.reverse()
      const g = o.BoundingRectangle.fromPoints(y, G)
      return (function (e, t, n, o) {
        const r = new p.GeometryAttributes()
        o.position &&
          (r.position = new s.GeometryAttribute({
        ...
        if (o.st || o.tangent || o.bitangent) {
          ...
          for (P = 0; P < g; P++) {
            for (
              p = P * o, c = i * (t[0].y + l), e[u++] = p, e[u++] = c, _ = 1;
              _ < d;
              _++
            )
              (c = i * (t[_].y + l)),
          ...
          for (_ = 0; _ < d; _++)
            (p = 0), (c = i * (t[_].y + l)), (e[u++] = p), (e[u++] = c)
          for (_ = 0; _ < d; _++)
            (p = (g - 1) * o),
              (c = i * (t[_].y + l)),
              (e[u++] = p),
              (e[u++] = c)
          r.st = new s.GeometryAttribute({
        ...
        if (
          (o.normal && (C = c.GeometryPipeline.computeNormal(C)),
          ...
          o.tangent || (C.attributes.tangent = void 0),
            o.bitangent || (C.attributes.bitangent = void 0),
            o.st || (C.attributes.st = void 0)
        }
        return C
      })(
        l.PolylineVolumeGeometryLibrary.computePositions(d, y, g, e, !0),
        y,
        g,
        e._vertexFormat
      )
