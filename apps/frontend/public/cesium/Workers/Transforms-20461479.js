define([
  ...
  ;(l.typeOf = {}),
    ...
    (l.typeOf.number.lessThan = function (e, t, n) {
      if ((l.typeOf.number(e, t), t >= n))
        throw new c(`Expected ${e} to be less than ${n}, actual value was ${t}`)
    }),
  ...
  ;(y.fromRectangle2D = function (e, t, n) {
    ...
    (y.fromRectangleWithHeights2D = function (e, t, o, s, a) {
      if ((r.defined(a) || (a = new y()), !r.defined(e)))
        return (
          (a.center = n.Cartesian3.clone(n.Cartesian3.ZERO, a.center)),
          (a.radius = 0),
          a
        )
      ;(t = r.defaultValue(t, T)),
        i.Rectangle.southwest(e, M),
        (M.height = o),
        i.Rectangle.northeast(e, D),
        (D.height = s)
      ...
      const p = a.center
      return (
        (p.x = u.x + 0.5 * l), (p.y = u.y + 0.5 * d), (p.z = u.z + 0.5 * f), a
      )
    })
  const U = []
  ...
  ;(y.projectTo2D = function (e, t, o) {
    ...
    u = n.Cartesian3.equals(s, n.Cartesian3.ZERO)
      ? n.Cartesian3.clone(n.Cartesian3.UNIT_X, Y)
      : i.geodeticSurfaceNormal(s, Y)
        ...
        ;(n = `${o}RequestFullscreen`),
          ...
          'function' == typeof document[n]
            ...
            : ((n = `${o}CancelFullScreen`),
              'function' == typeof document[n] && (re.exitFullscreen = n)),
          (n = `${o}FullscreenEnabled`),
          void 0 !== document[n]
            ? (re.fullscreenEnabled = n)
            : ((n = `${o}FullScreenEnabled`),
              void 0 !== document[n] && (re.fullscreenEnabled = n)),
          (n = `${o}FullscreenElement`),
          void 0 !== document[n]
            ? (re.fullscreenElement = n)
            : ((n = `${o}FullScreenElement`),
              void 0 !== document[n] && (re.fullscreenElement = n)),
          (n = `${o}fullscreenchange`),
          void 0 !== document[`on${n}`] &&
            ('ms' === o && (n = 'MSFullscreenChange'),
            (re.fullscreenchange = n)),
          (n = `${o}fullscreenerror`),
          void 0 !== document[`on${n}`] &&
            ('ms' === o && (n = 'MSFullscreenError'), (re.fullscreenerror = n))
      }
      return ne
    }),
  ...
  function Ee() {
    if (
      !r.defined(ce) &&
      ((ce = !1), !Ae() && !Pe() && / Safari\/[\.0-9]+/.test(se.userAgent))
    ) {
    ...
    if (!r.defined(pe)) {
      ...
      ;(pe = !1),
        'Microsoft Internet Explorer' === se.appName
          ? ((e = /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(se.userAgent)),
            null !== e && ((pe = !0), (he = Se(e[1]))))
          : 'Netscape' === se.appName &&
            ((e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(se.userAgent)),
            null !== e && ((pe = !0), (he = Se(e[1]))))
    }
    return pe
  }
      ...
      return (
        r.defined(_e) ||
          (_e =
            ...
            (!r.defined(se.pointerEnabled) || se.pointerEnabled)),
        _e
      )
    },
  ...
  ;(Ue.packedLength = 4),
    ...
    (Ue.convertPackedArrayForInterpolation = function (e, t, n, o) {
      ...
      for (let i = 0, s = n - t + 1; i < s; i++) {
        const n = 3 * i
        Ue.unpack(e, 4 * (t + i), We),
          Ue.multiply(We, Ye, We),
          We.w < 0 && Ue.negate(We, We),
          Ue.computeAxis(We, Le)
    ...
    (Ue.unpackInterpolationResult = function (e, t, o, i, s) {
      ...
      return (
        Ue.unpack(t, 4 * i, He),
        0 === a ? Ue.clone(Ue.IDENTITY, We) : Ue.fromAxisAngle(Qe, a, We),
        Ue.multiply(We, He, s)
      )
    }),
  ...
  Ue.lerp = function (e, t, n, r) {
    return (
      (Ze = Ue.multiplyByScalar(t, n, Ze)),
      (r = Ue.multiplyByScalar(e, 1 - n, r)),
      Ue.add(Ze, r, r)
    )
  }
  let Je = new Ue(),
  ...
  ;(Ue.slerp = function (e, t, n, r) {
    let i = Ue.dot(e, t),
      s = t
    if (
      (i < 0 && ((i = -i), (s = Je = Ue.negate(t, Je))),
      1 - i < o.CesiumMath.EPSILON6)
    )
      return Ue.lerp(e, s, n, r)
    const a = Math.acos(i)
    return (
  ...
  ;(it[7] = ot / 136),
    ...
    (Ue.fastSlerp = function (e, t, n, r) {
      ...
      const s = i - 1,
        ...
        c = a * a
      for (let e = 7; e >= 0; --e)
        (at[e] = (it[e] * u - st[e]) * s), (ut[e] = (it[e] * c - st[e]) * s)
      const l =
          o *
          n *
          (1 +
  ...
  function bt(e, t, n) {
    ...
    return (
      (e += r),
      (t -= ht.SECONDS_PER_DAY * r) < 0 && (e--, (t += ht.SECONDS_PER_DAY)),
      (n.dayNumber = e),
      (n.secondsOfDay = t),
      n
    )
  ...
  function xt(e, t, n, r, o, i, s) {
    ...
    const l =
      i +
      (r * ht.SECONDS_PER_HOUR +
        o * ht.SECONDS_PER_MINUTE +
        s * ht.SECONDS_PER_MILLISECOND)
  ...
  ;(zt.fromGregorianDate = function (e, t) {
    ...
    (zt.fromIso8601 = function (e, t) {
      ...
      return (
        r.defined(t)
          ? (bt(y[0], y[1], t), Ct(t))
          : (t = new zt(y[0], y[1], mt.UTC)),
        g && zt.addSeconds(t, 1, t),
        t
      )
    }),
    (zt.now = function (e) {
  ...
  ;(zt.toGregorianDate = function (e, t) {
    ...
    (zt.clone = function (e, t) {
      if (r.defined(e))
        return r.defined(t)
          ...
          : new zt(e.dayNumber, e.secondsOfDay, mt.TAI)
    }),
    ...
    (zt.equalsEpsilon = function (e, t, n) {
      return (
        ...
        e === t ||
          (r.defined(e) &&
            r.defined(t) &&
            Math.abs(zt.secondsDifference(e, t)) <= n)
      )
    }),
    ...
    (zt.secondsDifference = function (e, t) {
      return (
        (e.dayNumber - t.dayNumber) * ht.SECONDS_PER_DAY +
        (e.secondsOfDay - t.secondsOfDay)
      )
    }),
    (zt.daysDifference = function (e, t) {
      return (
        e.dayNumber -
        t.dayNumber +
        (e.secondsOfDay - t.secondsOfDay) / ht.SECONDS_PER_DAY
      )
    }),
    ...
    (Wt = function (e, t, n, r) {
      ...
      function i(e, t) {
        ...
        if (!(this instanceof i))
          return n ? (arguments.length >= 2 ? new i(e, t) : new i(e)) : new i()
        if (void 0 === e) {
          if (n)
      ...
      ;(i.decodePath = C('/', 'decodePathSegment')),
        ...
        (i.buildQueryParameter = function (e, t, n) {
          return (
            i.encodeQuery(e, n) + (null !== t ? '=' + i.encodeQuery(t, n) : '')
          )
        }),
        ...
        (s.href = function (e, t) {
          ...
          if (
            ...
            var s = r ? e._parts : e
            for (n in s)
              'query' !== n && a.call(this._parts, n) && (this._parts[n] = s[n])
      ...
      ;(s.protocol = function (e, t) {
        ...
        (s.origin = function (e, t) {
          ...
          var r = i(e)
          return (
            this.protocol(r.protocol()).authority(r.authority()).build(!t), this
          )
        }),
        (s.host = function (e, t) {
          if (this._parts.urn) return void 0 === e ? '' : this
      ...
      return (
        ...
        (s.readable = function () {
          ...
          if (
            ...
            for (
              var r = '', o = 0, s = t._parts.query.split('&'), a = s.length;
              o < a;
              o++
            ) {
              var u = (s[o] || '').split('=')
              ...
              !(function (n) {
                ...
                function q(e) {
                  ...
                  for (o = n > 0 ? n + 1 : 0; o < C; ) {
                    ...
                    ;(S = T(_ - i, (t = w.length + 1), 0 == i)),
                      x(_ / t) > u - b && A('overflow'),
                      (b += x(_ / t)),
                      (_ %= t),
                      w.splice(_++, 0, b)
                  }
                ...
                function z(e) {
                  var t,
                    ...
                    E = []
                  for (
                    w = (e = I(e)).length, t = g, n = 0, i = m, s = 0;
                    s < w;
                    ++s
                  )
                    (v = e[s]) < 128 && E.push(S(v))
                  for (r = o = E.length, o && E.push(y); r < w; ) {
                    for (a = u, s = 0; s < w; ++s)
                      (v = e[s]) >= t && v < a && (a = v)
                    for (
                      a - t > x((u - n) / (C = r + 1)) && A('overflow'),
                        n += (a - t) * C,
                        t = a,
                        s = 0;
                      s < w;
                      ...
                      if (
                        ((v = e[s]) < t && ++n > u && A('overflow'), v == t)
                      ) {
                        for (
                          f = n, p = c;
                          !(f < (h = p <= i ? l : p >= i + d ? d : p - i));
                          p += c
                        )
                          (b = f - h),
                            (_ = c - h),
  ...
  ;(cn.prototype.cancel = function () {
    ...
    (pn.prototype.pop = function (e) {
      ...
      const t = this._array,
        n = t[e]
      return (
        hn(t, e, --this._length), this.heapify(e), (t[this._length] = void 0), n
      )
    })
  const mn = {
  ...
  function Sn(e) {
    return (
      e.state === an.UNISSUED && ((e.state = an.ISSUED), (e.deferred = Xt())),
      e.deferred.promise
    )
  }
  function An(e) {
  ...
  ;(bn.maximumRequests = 50),
    ...
    (bn.update = function () {
      ...
      for (e = 0; e < r; ++e)
        (t = vn[e]),
          t.cancelled && En(t),
          t.state === an.ACTIVE ? n > 0 && (vn[e - n] = t) : ++n
      vn.length -= n
      ...
      for (; a < s && yn.length > 0; )
        (t = yn.pop()),
          t.cancelled
            ? En(t)
            : !t.throttleByServer || bn.serverHasOpenSlots(t.serverKey)
            ? (An(t), ++a)
            : En(t)
      !(function () {
        ...
        0 === mn.numberOfActiveRequests &&
          ...
          (mn.numberOfAttemptedRequests > 0 &&
            (console.log(
              `Number of attempted requests: ${mn.numberOfAttemptedRequests}`
            ),
            (mn.numberOfAttemptedRequests = 0)),
          mn.numberOfCancelledRequests > 0 &&
            (console.log(
              `Number of cancelled requests: ${mn.numberOfCancelledRequests}`
            ),
            (mn.numberOfCancelledRequests = 0)),
          mn.numberOfCancelledActiveRequests > 0 &&
            (console.log(
              `Number of cancelled active requests: ${mn.numberOfCancelledActiveRequests}`
            ),
            (mn.numberOfCancelledActiveRequests = 0)),
          mn.numberOfFailedRequests > 0 &&
            (console.log(
              `Number of failed requests: ${mn.numberOfFailedRequests}`
            ),
            (mn.numberOfFailedRequests = 0)))
    ...
    (bn.request = function (e) {
      if (sn(e.url) || nn(e.url))
        return _n.raiseEvent(), (e.state = an.RECEIVED), e.requestFunction()
      if (
        (++mn.numberOfAttemptedRequests,
        r.defined(e.serverKey) || (e.serverKey = bn.getServerKey(e.url)),
        bn.throttleRequests &&
          e.throttleByServer &&
          !bn.serverHasOpenSlots(e.serverKey))
      )
        return
  ...
  function Mn(e) {
    if (e.state === an.ISSUED || e.state === an.ACTIVE)
      ...
      return s.catch(function (r) {
        return i.state !== an.FAILED
          ...
          : e.retryOnError(r).then(function (o) {
              return o
                ? ((i.state = an.UNISSUED), (i.deferred = void 0), Nn(e, t, n))
                : Promise.reject(r)
            })
      })
  }
  ;(Un.createIfNeeded = function (e) {
    ...
    (Un.supportsImageBitmapOptions = function () {
      ...
      if ('function' != typeof createImageBitmap)
        return (kn = Promise.resolve(!1)), kn
      return (
        (kn = Un.fetchBlob({
    ...
    Object.defineProperties(Un.prototype, {
      ...
      isCrossOriginUrl: {
        get: function () {
          return (function (e) {
            r.defined(rn) || (rn = document.createElement('a')),
              (rn.href = window.location.href)
            const t = rn.host,
              n = rn.protocol
            return (
              (rn.href = e),
              (rn.href = rn.href),
              n !== rn.protocol || t !== rn.host
            )
          })(this._url)
        }
      },
    ...
    (Un.prototype.setQueryParameters = function (e, t) {
      this._queryParameters = t
        ? Dn(this._queryParameters, e, !1)
        : Dn(e, this._queryParameters, !1)
    }),
    ...
    (Un.prototype.getDerivedResource = function (e) {
      ...
      if (((t._retryCount = 0), r.defined(e.url))) {
        ...
        Tn(n, t, !0, r.defaultValue(e.preserveQueryParameters, !1)),
          ...
          '' !== n.scheme()
            ? (t._url = n.toString())
            : (t._url = n.absoluteTo(new Zt(Gt(this._url))).toString())
      }
      return (
    ...
    (Un.prototype.getBaseUri = function (e) {
      return (function (e, t) {
        ...
        return (
          ...
          t
            ? (0 !== (e = new Zt(e)).query().length && (n += `?${e.query()}`),
    ...
    (Un.prototype.fetchImage = function (e) {
      ...
      if (
        (Mn(this.request),
        !Rn || this.isDataUri || this.isBlobUri || (!this.hasHeaders && !n))
      )
        return Fn({
          resource: this,
          flipY: o,
  ...
  ;(Un.prototype.fetch = function (e) {
    ...
    (Un._Implementations.createImage = function (e, t, n, o, i, s) {
      ...
      Un.supportsImageBitmapOptions()
        .then(function (c) {
          if (!c || !s)
            return void Un._Implementations.loadImageElement(u, t, n)
          const l = Xt(),
  ...
  ;(Un._Implementations.loadWithXhr = function (t, n, o, i, s, c, l) {
            ...
            e.request(t)
              .on('response', function (e) {
                if (e.statusCode < 200 || e.statusCode >= 300)
                  return void s.reject(new ln(e.statusCode, e, e.headers))
                const t = []
      ...
      (f.onload = function () {
        if ((f.status < 200 || f.status >= 300) && (!p || 0 !== f.status))
          return void c.reject(
            new ln(f.status, f.response, f.getAllResponseHeaders())
          )
        const e = f.response,
          t = f.responseType
        if ('HEAD' === o || 'OPTIONS' === o) {
    ...
    (Qn.prototype.compute = function (e, t) {
      ...
      if (
        (r.defined(t) || (t = new lt(0, 0, 0, 0, 0)),
      ...
      return (
        a >= 0
          ? (a < n.length - 1 && n[a + 1].equals(e) && ++a, (i = a), (s = a))
          : ((s = ~a), (i = s - 1), i < 0 && (i = 0)),
        (this._lastIndex = i),
        Jn(this, n, this._samples, e, i, s, t),
        t
  ...
  function nr(e) {
    return 'undefined' == typeof document
      ? e
      : (r.defined(Kn) || (Kn = document.createElement('a')),
        (Kn.href = e),
        (Kn.href = Kn.href),
        Kn.href)
  }
  ...
  function lr(e, t, n) {
    ...
    return (
      (r.dayNumber = t),
      (r.secondsOfDay = n),
      zt.daysDifference(r, e._sampleZeroDateTT)
    )
  }
  function dr(e, t) {
    ...
    n = r.defined(o)
      ...
      : new Un({ url: sr(`Assets/IAU2006_XYS/IAU2006_XYS_${t}.json`) })
  ...
  ;(ur.prototype.preload = function (e, t, n, r) {
    ...
    (ur.prototype.computeXysRadians = function (e, t, n) {
      ...
      if (
        (r.defined(l[3 * a]) ||
          (dr(this, (a / this._samplesPerXysFile) | 0), (c = !0)),
        r.defined(l[3 * u]) ||
          (dr(this, (u / this._samplesPerXysFile) | 0), (c = !0)),
        c)
      )
        return
  ...
  ;(fr.localFrameToFixedFrameGenerator = function (e, t) {
    if (!pr.hasOwnProperty(e) || !pr[e].hasOwnProperty(t))
      throw new c(
      ...
      r.defined(mr[u])
        ...
        : ((a = function (a, u, c) {
            if (
              ...
              o.CesiumMath.equalsEpsilon(a.x, 0, o.CesiumMath.EPSILON14) &&
              o.CesiumMath.equalsEpsilon(a.y, 0, o.CesiumMath.EPSILON14)
            ) {
              const r = o.CesiumMath.sign(a.z)
              n.Cartesian3.unpack(hr[e], 0, yr),
                'east' !== e &&
                  'west' !== e &&
                  n.Cartesian3.multiplyByScalar(yr, r, yr),
                n.Cartesian3.unpack(hr[t], 0, vr),
                'east' !== t &&
                  'west' !== t &&
                  n.Cartesian3.multiplyByScalar(vr, r, vr),
                n.Cartesian3.unpack(hr[s], 0, wr),
                'east' !== s &&
                  'west' !== s &&
                  n.Cartesian3.multiplyByScalar(wr, r, wr)
            } else {
              ;(u = r.defaultValue(u, n.Ellipsoid.WGS84)).geodeticSurfaceNormal(
                a,
                gr.up
              )
              const o = gr.up,
    ...
    (fr.eastNorthUpToFixedFrame = fr.localFrameToFixedFrameGenerator(
      'east',
      'north'
    )),
    (fr.northEastDownToFixedFrame = fr.localFrameToFixedFrameGenerator(
      'north',
      'east'
    )),
    (fr.northUpEastToFixedFrame = fr.localFrameToFixedFrameGenerator(
      'north',
      'up'
    )),
    (fr.northWestUpToFixedFrame = fr.localFrameToFixedFrameGenerator(
      'north',
      'west'
    ))
  const Cr = new Ue(),
  ...
  fr.headingPitchRollToFixedFrame = function (e, t, o, s, a) {
    ...
    const u = Ue.fromHeadingPitchRoll(t, Cr),
      c = i.Matrix4.fromTranslationQuaternionRotationScale(
        n.Cartesian3.ZERO,
        u,
        _r,
        br
  ...
  fr.fixedFrameToHeadingPitchRoll = function (e, t, o, s) {
    ;(t = r.defaultValue(t, n.Ellipsoid.WGS84)),
      (o = r.defaultValue(o, fr.eastNorthUpToFixedFrame)),
      r.defined(s) || (s = new Xn())
    const a = i.Matrix4.getTranslation(e, Er)
    if (n.Cartesian3.equals(a, n.Cartesian3.ZERO))
      return (s.heading = 0), (s.pitch = 0), (s.roll = 0), s
    let u = i.Matrix4.inverseTransformation(o(a, t, Or), Or),
      c = i.Matrix4.setScale(e, Ar, Ir)
    ;(c = i.Matrix4.setTranslation(c, n.Cartesian3.ZERO, c)),
      (u = i.Matrix4.multiply(u, c, u))
  ...
  ;(fr.computeTemeToPseudoFixedMatrix = function (e, t) {
    ...
    a =
      s >= 43200
        ? (u + 0.5) / ht.DAYS_PER_JULIAN_CENTURY
        : (u - 0.5) / ht.DAYS_PER_JULIAN_CENTURY
    const c =
        ...
        (72921158553e-15 + 11772758384668e-32 * (i - 2451545.5)) *
          ((s + 0.5 * ht.SECONDS_PER_DAY) % ht.SECONDS_PER_DAY),
      l = Math.cos(c),
      d = Math.sin(c)
    return r.defined(t)
      ? ((t[0] = l),
  ...
  fr.computeFixedToIcrfMatrix = function (e, t) {
    ...
    const p = n.Matrix3.fromRotationZ(-u.s, kr),
      ...
      g =
        (e.secondsOfDay - zt.computeTaiMinusUtc(e) + i.ut1MinusUtc) /
        ht.SECONDS_PER_DAY
  ...
  ;(fr.pointToWindowCoordinates = function (e, t, n, r) {
    return (
      ((r = fr.pointToGLWindowCoordinates(e, t, n, r)).y = 2 * t[5] - r.y), r
    )
  }),
    (fr.pointToGLWindowCoordinates = function (e, t, n, o) {
      ...
      const s = Fr
      return (
        i.Matrix4.multiplyByVector(
          e,
          i.Cartesian4.fromElements(n.x, n.y, n.z, 1, s),
          s
        ),
