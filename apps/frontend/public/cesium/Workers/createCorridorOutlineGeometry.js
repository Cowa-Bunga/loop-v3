define([
  ...
  function w(e, t) {
      ...
      if (s.defined(r)) {
        for (H -= 3, l = x, u.push(k), e = 0; e < r.length / 3; e++)
          (d = i.Cartesian3.fromArray(r, 3 * e, d)),
            ...
            (H -= 3)
        u.push(l - Math.floor(r.length / 6)),
          t === o.CornerType.BEVELED && u.push((H - 2) / 3 + 1),
          (O += 3)
      } else {
        for (O += 3, l = k, u.push(x), e = 0; e < a.length / 3; e++)
          (d = i.Cartesian3.fromArray(a, 3 * e, d)),
            (M[B++] = l + e),
            (M[B++] = l + e + 1),
            n.CorridorGeometryLibrary.addAttribute(w, d, O),
            (O += 3)
        u.push(l + Math.floor(a.length / 6)),
          t === o.CornerType.BEVELED && u.push(O / 3 - 1),
          (H -= 3)
      }
      for (
        R = p[S++],
    ...
    return (
      (M[B++] = O / 3),
      (M[B++] = (H - 2) / 3),
      (c.position = new a.GeometryAttribute({
  ...
  function L(e) {
    ...
    ;(this._positions = t),
      ...
      (this.packedLength =
        1 + t.length * i.Cartesian3.packedLength + i.Ellipsoid.packedLength + 6)
  }
        ...
        (A.height = g),
          ...
          (_ = (function (e) {
            ...
            if (
              ...
              h.applyOffset = new a.GeometryAttribute({
            ...
            let A
            const _ = c.length,
              E = d.IndexDatatype.createTypedArray(
                m.length / 3,
                2 * (_ + o.length)
              )
            E.set(c)
