define([
  ...
  function T(t, n) {
    ...
    for (let t = p; t < d; ++t)
      for (let e = 0; e < l; ++e)
        g.RectangleGeometryLibrary.computePosition(n, i, a.st, t, e, x, w),
          (h[_++] = x.x),
          (h[_++] = x.y),
          (h[_++] = x.z),
          a.st &&
    ...
    if (
      (u &&
        (g.RectangleGeometryLibrary.computePosition(n, i, a.st, 0, 0, x, w),
        (h[_++] = x.x),
        (h[_++] = x.y),
        (h[_++] = x.z),
        a.st &&
          ...
          (D = w.y))),
      m &&
        (g.RectangleGeometryLibrary.computePosition(n, i, a.st, s - 1, 0, x, w),
        (h[_++] = x.x),
        (h[_++] = x.y),
        (h[_] = x.z),
        a.st &&
      ...
      for (let t = 0; t < b.length; t += 2)
        (b[t] = (b[t] - G) / (V - G)), (b[t + 1] = (b[t + 1] - P) / (D - P))
    const M = (function (t, n, a, o) {
      ...
      if (n.normal || n.tangent || n.bitangent)
        for (let g = 0; g < r; g += 3) {
          const r = e.Cartesian3.fromArray(t, g, C),
            d = u + 1,
            y = u + 2
          ;(p = a.geodeticSurfaceNormal(r, p)),
            (n.tangent || n.bitangent) &&
              ...
              n.bitangent &&
                e.Cartesian3.normalize(e.Cartesian3.cross(p, m, c), c)),
            n.normal && ((i[u] = p.x), (i[d] = p.y), (i[y] = p.z)),
            n.tangent && ((s[u] = m.x), (s[d] = m.y), (s[y] = m.z)),
            n.bitangent && ((l[u] = c.x), (l[d] = c.y), (l[y] = c.z)),
            (u += 3)
        }
  ...
  const S = new d.VertexFormat()
  function I(n, a) {
    const i = n._shadowVolume,
      g = n._offsetAttribute,
      y = n._vertexFormat,
      f = n._extrudedHeight,
      h = n._surfaceHeight,
      b = n._ellipsoid,
    ...
    let x
    if (i) {
      const t = d.VertexFormat.clone(y, S)
      ;(t.normal = !0), (n._vertexFormat = t)
    }
    const w = T(n, a)
    i && (n._vertexFormat = y)
    let G = p.PolygonPipeline.scaleToGeodeticHeight(
    ...
    V.set(G)
    const I = p.PolygonPipeline.scaleToGeodeticHeight(
      w.attributes.position.values,
      f,
      b
    )
    ...
    let U, Y, q
    if (y.normal) {
      for (Y = w.attributes.normal.values, k.set(Y), x = 0; x < F; x++)
        Y[x] = -Y[x]
      k.set(Y, F), (w.attributes.normal.values = k)
    }
    if (i) {
      ;(Y = w.attributes.normal.values),
        y.normal || (w.attributes.normal = void 0)
    ...
    if (X) {
      ...
      g === l.GeometryOffsetAttribute.TOP
        ? (e = e.fill(1, 0, t / 2))
        : ((q = g === l.GeometryOffsetAttribute.NONE ? 0 : 1), (e = e.fill(q))),
    ...
    y.st &&
      ((U = w.attributes.st.values),
      B.set(U),
      B.set(U, (F / 3) * 2),
      (w.attributes.st.values = B))
    const Q = w.indices,
      W = Q.length,
      J = F / 3,
      j = c.IndexDatatype.createTypedArray(P / 3, 2 * W)
    for (j.set(Q), x = 0; x < W; x += 3)
      (j[x + W] = Q[x + 2] + J),
        (j[x + 1 + W] = Q[x + 1] + J),
        (j[x + 2 + W] = Q[x] + J)
    w.indices = j
    ...
    const ut = g === l.GeometryOffsetAttribute.TOP
    X &&
      !ut &&
      ((q = g === l.GeometryOffsetAttribute.ALL ? 1 : 0), (st = st.fill(q)))
    let ct = 0,
      mt = 0,
      pt = 0,
      gt = 0
      ...
      if (n.normal || n.tangent || n.bitangent)
        for (let f = 0; f < o; f += 6) {
          ...
          e.Cartesian3.equalsEpsilon(b, h, m.CesiumMath.EPSILON10) && (p = !0),
            (n.tangent || n.bitangent) &&
              ((g = a.geodeticSurfaceNormal(h, g)),
              n.tangent &&
                (d = e.Cartesian3.normalize(e.Cartesian3.cross(g, y, d), d))),
            n.normal &&
              ((r[l++] = y.x),
              (r[l++] = y.y),
              (r[l++] = y.z),
    ...
    y.st &&
      (ft.attributes.st = new r.GeometryAttribute({
        componentDatatype: o.ComponentDatatype.FLOAT,
        componentsPerAttribute: 2,
        values: lt
      })),
    ...
    return (
      (ft.indices = ht),
      (ft = u.GeometryPipeline.combineInstances([
        new s.GeometryInstance({ geometry: w }),
        new s.GeometryInstance({ geometry: ft })
      ])),
      ft[0]
    )
  }
  ...
  function B(t, e, a, o, r) {
    ...
    const i = g.RectangleGeometryLibrary.computeOptions(t, e, a, 0, G, H),
      s = i.height,
      l = i.width,
      u = k
    return (
      g.RectangleGeometryLibrary.computePosition(i, o, !1, 0, 0, u[0]),
      g.RectangleGeometryLibrary.computePosition(i, o, !1, 0, l - 1, u[1]),
      g.RectangleGeometryLibrary.computePosition(i, o, !1, s - 1, 0, u[2]),
      g.RectangleGeometryLibrary.computePosition(i, o, !1, s - 1, l - 1, u[3]),
  ...
  function U(a) {
    ...
    ;(this._rectangle = n.Rectangle.clone(o)),
      (this._granularity = t.defaultValue(
        a.granularity,
        m.CesiumMath.RADIANS_PER_DEGREE
      )),
      (this._ellipsoid = e.Ellipsoid.clone(
        t.defaultValue(a.ellipsoid, e.Ellipsoid.WGS84)
      )),
  ...
  ;(U.packedLength =
    ...
    (U.pack = function (a, o, r) {
      return (
        ...
        d.VertexFormat.pack(a._vertexFormat, o, r),
  ...
  ;(U.unpack = function (a, o, r) {
    ...
    const l = d.VertexFormat.unpack(a, o, S)
    ...
    return t.defined(r)
      ? ((r._rectangle = n.Rectangle.clone(i, r._rectangle)),
        ...
        (r._vertexFormat = d.VertexFormat.clone(l, r._vertexFormat)),
        (r._granularity = u),
        (r._surfaceHeight = c),
        (r._rotation = m),
        (r._stRotation = p),
  ...
  ;(U.createGeometry = function (i) {
    ...
    const u = i._ellipsoid,
      ...
      d = i._stRotation,
      y = i._vertexFormat,
      f = g.RectangleGeometryLibrary.computeOptions(
        s,
        i._granularity,
        c,
        d,
    ...
    if (0 !== d || 0 !== c) {
      ...
      a.Quaternion.fromAxisAngle(o, -d, W), e.Matrix3.fromQuaternion(W, h)
    ...
    let x, w
    if (
      ((f.lonScalar = 1 / i._rectangle.width),
      (f.latScalar = 1 / i._rectangle.height),
      (f.tangentRotationMatrix = h),
      (s = i._rectangle),
      A)
    ) {
      x = I(i, f)
      ...
      if (
        ((x = T(i, f)),
        (x.attributes.position.values = p.PolygonPipeline.scaleToGeodeticHeight(
            ...
            t.defined(this._textureCoordinateRotationPoints) ||
              (this._textureCoordinateRotationPoints = (function (t) {
                ...
                const c = i[0],
                  ...
                  g = new Array(6)
                return (
                  n.Cartesian2.pack(c, g),
                  n.Cartesian2.pack(m, g, 2),
                  n.Cartesian2.pack(p, g, 4),
                  g
                )
              })(this)),
