  ...
  return i(function (i, o) {
    ...
    for (L = 0; L < W; ++L) {
      ...
      for (let r = 0; r < t; ++r) {
        ...
        e.Cartesian3.subtract(s, E, s),
          e.Cartesian3.subtract(i, E, i),
          e.Cartesian3.subtract(o, E, o)
        const c = r === t - 1 ? 2 : 4
        for (let t = 0 === r ? 2 : 0; t < c; ++t) {
          e.Cartesian3.pack(i, M, S),
            e.Cartesian3.pack(s, R, S),
            e.Cartesian3.pack(o, T, S),
            (S += 3)
          const r = t - 2 < 0 ? -1 : 1
    ...
    if (i.keepDecodedPositions) {
      ...
      o.push(I.buffer, e.buffer),
        (H = t.combine(H, {
          decodedPositions: I.buffer,
          decodedPositionOffsets: e.buffer
        }))
    }
    return H
  })
