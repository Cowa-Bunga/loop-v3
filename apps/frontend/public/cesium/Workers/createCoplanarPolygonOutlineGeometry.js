define([
  ...
  function k(e) {
    const t = (e = i.defaultValue(e, i.defaultValue.EMPTY_OBJECT))
      .polygonHierarchy
    ;(this._polygonHierarchy = t),
      (this._workerName = 'createCoplanarPolygonOutlineGeometry'),
      (this.packedLength =
        u.PolygonGeometryLibrary.computeHierarchyPackedLength(t, n.Cartesian3) +
        1)
  }
  ;(k.fromPositions = function (e) {
    return new k({
      polygonHierarchy: {
        positions: (e = i.defaultValue(e, i.defaultValue.EMPTY_OBJECT))
          .positions
      }
    })
  }),
    (k.pack = function (e, t, o) {
      return (
        ...
        (t[
          (o = u.PolygonGeometryLibrary.packPolygonHierarchy(
            e._polygonHierarchy,
            t,
            o,
            n.Cartesian3
  ...
  return (
    (k.unpack = function (e, t, o) {
      ...
      const r = u.PolygonGeometryLibrary.unpackPolygonHierarchy(
        e,
        t,
        n.Cartesian3
      )
      ...
      const a = e[t]
      return (
        i.defined(o) || (o = new k(w)),
        (o._polygonHierarchy = r),
        (o.packedLength = a),
        o
      )
    }),
    (k.createGeometry = function (o) {
      ...
      let y = i.positions
      if (
        ((y = e.arrayRemoveDuplicates(y, n.Cartesian3.equalsEpsilon, !0)),
        y.length < 3)
      )
        return
