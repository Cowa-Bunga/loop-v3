define([
  ...
  const k = {}
  k.DEFAULT_STRUCTURE = Object.freeze({
    heightScale: 1,
    heightOffset: 0,
    elementsPerHeight: 1,
    stride: 1,
  ...
  k.computeVertices = function (f) {
    ...
    const R = n.defaultValue(f.includeWebMercatorT, !1),
      ...
      X = n.defaultValue(
        _.elementsPerHeight,
        k.DEFAULT_STRUCTURE.elementsPerHeight
      ),
      Z = n.defaultValue(_.stride, k.DEFAULT_STRUCTURE.stride),
      j = n.defaultValue(
        _.elementMultiplier,
        k.DEFAULT_STRUCTURE.elementMultiplier
      ),
    ...
    R &&
      ...
      (oe =
        1 / (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(F) - le)))
    const fe = U
    ;(fe.x = Number.POSITIVE_INFINITY),
      (fe.y = Number.POSITIVE_INFINITY),
      (fe.z = Number.POSITIVE_INFINITY)
    const ue = b
    ;(ue.x = Number.NEGATIVE_INFINITY),
      (ue.y = Number.NEGATIVE_INFINITY),
      (ue.z = Number.NEGATIVE_INFINITY)
    ...
    for (let t = ke; t < ye; ++t) {
      ...
      R &&
        (b =
          (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(n) - le) *
          oe)
      for (let t = Ie; t < Ue; ++t) {
        let n = t
        n < 0 && (n = 0), n >= w && (n = w - 1)
    ...
    let Te, Ve
    if (
      (n.defined(S) && (Te = l.OrientedBoundingBox.fromRectangle(S, ae, ne, A)),
      O)
    ) {
      Ve = new r.EllipsoidalOccluder(
        A
      ).computeHorizonCullingPointPossiblyUnderEllipsoid(N, me, ae)
    }
    ...
    let De = 0
    for (let e = 0; e < he; ++e)
      De = Ae.encode(Be, De, me[e], pe[e], ge[e], void 0, xe[e], we[e])
    return {
      vertices: Be,
      maximumHeight: ne,
      minimumHeight: ae,
      ...
      var e,
        ...
        p =
          ((e = {
            ...
            decode: function (r, s) {
              var l =
                  (s = s || {}).encodedMaskData || null === s.encodedMaskData,
                o = n(r, s.inputOffset || 0, l),
                f =
                  null !== s.noDataValue ? s.noDataValue : e.defaultNoDataValue,
                u = t(
                  o,
                  s.pixelType || Float32Array,
                  s.encodedMaskData,
                  f,
                  s.returnMask
                ),
              ...
              return (
                ...
                s.returnFileInfo &&
                  ((c.fileInfo = i(o)),
                  s.computeUsedBitDepths && (c.fileInfo.bitDepths = a(o))),
                c
              )
            }
          }),
          (t = function (e, t, i, a, n) {
            ...
            ;(i = i || (e.mask ? e.mask.bitset : null)),
              ...
              n && i && (o = new Uint8Array(e.width * e.height))
              ...
              if (0 !== y)
                for (var I = 0; I <= u; I++) {
                  ...
                  if (0 !== U) {
                    ...
                    if (1 === B.encoding && M !== B.numValidPixels)
          ...
          (n = function (e, t, i) {
            ...
            if (
              ((a.fileIdentifierString = String.fromCharCode.apply(null, n)),
              'CntZImage' !== a.fileIdentifierString.trim())
            )
              throw (
                'Unexpected file identifier string: ' + a.fileIdentifierString
              )
            t += 10
            ...
            for (var g = 0, p = 0; p < m; p++)
              for (var x = 0; x < h; x++) {
                ...
                if (2 !== y.encoding) {
                  if (0 !== I && 2 !== I) {
                    if (((I >>= 6), (y.offsetType = I), 2 === I))
                      (y.offset = r.getInt8(1)), w++
                    ...
                    if (1 === y.encoding)
                      if (
                        ...
                        (y.numValidPixels = r.getUint16(w, !0)), (w += 2)
                      else {
                  ...
                  if (((t += w), 3 !== y.encoding))
                    if (0 === y.encoding) {
                      ...
                      ;(U = new ArrayBuffer(4 * b)),
                        new Uint8Array(U).set(new Uint8Array(e, t, 4 * b))
                      var M = new Float32Array(U)
                      ;(y.rawData = M), (t += 4 * b)
                    } else if (1 === y.encoding) {
                      var T = Math.ceil(
                          (y.numValidPixels * y.bitsPerPixel) / 8
                        ),
                        V = Math.ceil(T / 4)
                      ;(U = new ArrayBuffer(4 * V)),
                        new Uint8Array(U).set(new Uint8Array(e, t, T)),
                        (y.stuffedData = new Uint32Array(U)),
                        (t += T)
                    }
                } else t++
              }
          ...
          (d = {
            ...
            readHeaderInfo: function (e, t) {
              var i = t.ptr,
                ...
                n = {}
              if (
                ((n.fileIdentifierString = String.fromCharCode.apply(null, a)),
              ...
              if (
                ...
                l >= 3 &&
                  ...
                  this.computeChecksumFletcher32(
                    new Uint8Array(e, i - r, n.blobSize - 14)
                  ) !== n.checksum))
              )
            ...
            readDataOneSweep: function (e, t, i) {
              ...
              if (a.length === l * s) t.pixels.resultPixels = a
                ...
                if (s > 1)
                  for (g = 0; g < s; g++)
                    for (p = g * l, m = 0; m < l; m++)
                      u[m] && (t.pixels.resultPixels[p + m] = a[h++])
                else
                  for (m = 0; m < l; m++)
                    u[m] && (t.pixels.resultPixels[m] = a[h++])
              }
            ...
            readHuffmanTree: function (e, t) {
              ...
              var o,
                ...
                m = []
              for (o = r; o < s; o++)
                m[(f = o - (o < n ? 0 : n))] = { first: l[o - r], second: null }
              ...
              for (o = 0; o < m.length; o++)
                void 0 !== m[o] && (U = Math.max(U, m[o].first))
              ;(b = U >= i ? i : U),
                U >= 30 && console.log('WARning, large NUM LUT BITS IS ' + U)
              var T,
                V,
                v,
                A,
                ...
                if ((c = m[(f = o - (o < n ? 0 : n))].first) > 0)
                  if (((T = [c, f]), c <= b))
                    ...
                    for (V = m[f].second, B = M, A = c - 1; A >= 0; A--)
                      (V >>> A) & 1
                        ? (B.right || (B.right = new h()), (B = B.right))
                        : (B.left || (B.left = new h()), (B = B.left)),
                        0 !== A || B.val || (B.val = T[1])
              return {
                decodeLut: D,
                numBitsLUTQick: b,
            ...
            readHuffman: function (e, t, i) {
              ...
              for (A = 0; A < d.numDims; A++) {
                if (
                  (h > 1 && ((P = new i(S.buffer, p * A, p)), (v = 0)),
            ...
            decodeBits: function (e, t, i, a, n) {
              ...
              if (w) {
                ...
                ;(M = Math.ceil((y * B) / 8)),
                  ...
                  (t.ptr += M),
                  (V =
                    d >= 3 ? f(v, k, A - 1, a, D, S) : l(v, k, A - 1, a, D, S)),
            ...
            readTiles: function (e, t, i) {
              var a = t.headerInfo,
                ...
                f = Math.ceil(n / s),
                u = Math.ceil(r / s)
              ;(t.pixels.numBlocksY = u),
                (t.pixels.numBlocksX = f),
                (t.pixels.ptr = 0)
              var c,
                h,
                m,
              ...
              for (U = 0; U < u; U++)
                for (M = U !== u - 1 ? s : N, b = 0; b < f; b++)
                  for (
                    ...
                    if ((p = 3 & v) > 3)
                      throw ((t.ptr += C), 'Invalid block encoding (' + p + ')')
                    if (2 !== p)
                      if (0 === p) {
                        if (
                        ...
                        ((x = d.getDataTypeUsed(l, A)),
                        (w = d.getOnePixel(h, C, x, c)),
                        (C += d.getDataTypeSize(x)),
                        3 === p)
                      )
                        ...
                        ((t.ptr += C), d.decodeBits(e, t, F, w, k), (C = 0), L)
                      )
                        for (y = 0; y < M; y++) {
            ...
            constructConstantSurface: function (e) {
              ...
              if (o)
                if (i > 1)
                  ...
                  for (s = 0; s < a; s++) o[s] && (e.pixels.resultPixels[s] = t)
          ...
          }),
          {
            decode: function (e, t) {
              var i = (t = t || {}).noDataValue,
                ...
                n = {}
              if (
                ((n.ptr = t.inputOffset || 0),
                (n.pixels = {}),
                d.readHeaderInfo(e, n))
              ) {
                var r = n.headerInfo,
                  s = r.fileVersion,
                  l = d.getDataTypeArray(r.imageType)
                d.readMask(e, n),
                  r.numValidPixel === r.width * r.height ||
                    n.pixels.resultMask ||
                ...
                if (
                  ...
                  if (r.zMax === r.zMin) d.constructConstantSurface(n)
                  else if (s >= 4 && d.checkMinMaxRanges(e, n))
                    d.constructConstantSurface(n)
                  else {
                    ...
                    if ((n.ptr++, c)) d.readDataOneSweep(e, n, l)
                      ...
                      s > 1 &&
                      r.imageType <= 1 &&
                      Math.abs(r.maxZError - 0.5) < 1e-5
                    ) {
                      var h = u.getUint8(1)
                      if (
                        (n.ptr++, (n.encodeMode = h), h > 2 || (s < 4 && h > 1))
                      )
                ...
                ;(n.eofOffset = n.ptr),
                  t.inputOffset
                    ? ((o = n.headerInfo.blobSize + t.inputOffset - n.ptr),
                      Math.abs(o) >= 1 &&
                        (n.eofOffset = t.inputOffset + n.headerInfo.blobSize))
                    : ((o = n.headerInfo.blobSize - n.ptr),
                      Math.abs(o) >= 1 && (n.eofOffset = n.headerInfo.blobSize))
                var m = {
                  width: r.width,
                  height: r.height,
                ...
                if (
                  n.pixels.resultMask &&
                  d.isValidPixelValue(r.imageType, i)
                ) {
                ...
                return (
                  (n.noDataValue = i),
                  t.returnFileInfo && (m.fileInfo = d.formatFileInfo(n)),
                  m
                )
              }
            },
  ...
  return u(function (t, i) {
    if (t.encoding === w.LERC) {
      ...
      if (e.statistics[0].minValue === Number.MAX_VALUE)
        throw new f.RuntimeError('Invalid tile data')
      ;(t.heightmap = e.pixels[0]), (t.width = e.width), (t.height = e.height)
    }
    ;(t.ellipsoid = e.Ellipsoid.clone(t.ellipsoid)),
      (t.rectangle = a.Rectangle.clone(t.rectangle))
