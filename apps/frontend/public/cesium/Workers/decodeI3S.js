define([
  ...
  function s(e, t, n) {
    ...
    let l = (function (e, t, n, r, o, i) {
      ...
      o,
      i,
      a(s, u, n.width, n.buffer),
      a(c, u, n.width, n.buffer),
      a(s, f, n.width, n.buffer),
      a(c, f, n.width, n.buffer)
    )
  ...
  function u(e, t, o) {
    for (let i = 0; i < o.length; i++) {
      ...
      if ('WebMercator' === o[i].projectionType) {
        ...
        u = new n.WebMercatorProjection(new r.Ellipsoid(a.x, a.y, a.z)).project(
          new r.Cartographic(e, t, 0)
        )
      } else (u.x = e), (u.y = t)
      if (u.x > a.west && u.x < a.east && u.y > a.south && u.y < a.north)
        return s(u.x, u.y, o[i])
    }
    return 0
  }
  function c(e, n, r, o) {
    ...
    return a[0] === 'D'.charCodeAt() &&
      ...
      ? (function (e) {
          ...
          let c, l
          s === n.TRIANGULAR_MESH &&
            ((c = new n.Mesh()), (l = a.DecodeBufferToMesh(r, c)))
          ...
          if (t.defined(l) && l.ok() && 0 !== c.ptr) {
            ...
            for (let t = 0; t < e; ++t)
              a.GetFaceFromMesh(c, t, s),
                (i[3 * t] = s.GetValue(0)),
                (i[3 * t + 1] = s.GetValue(1)),
                (i[3 * t + 2] = s.GetValue(2))
            n.destroy(s)
            for (let e = 0; e < r; ++e) {
              ...
              if (0 !== y.ptr) {
                ...
                for (let t = 0; t < e; ++t) {
                  ...
                  'i3s-scale_x' === e
                    ...
                    : 'i3s-attribute-type' === e &&
                      (l = u.GetStringEntry(y, 'i3s-attribute-type'))
                }
              }
              t.defined(d[l]) && console.log('Attribute already exists', l),
                (d[l] = i),
                'feature-index' === l && d.featureCount++
            }
            n.destroy(c)
          }
      ...
      : (function (e, n, r, o) {
          ...
          try {
            let s = 0
            if (
              ((i.vertexCount = a.getUint32(s, 1)),
              (s += 4),
              (i.featureCount = a.getUint32(s, 1)),
              (s += 4),
              t.defined(r))
            )
              for (let n = 0; n < r.attributes.length; n++)
                t.defined(l[r.attributes[n]])
                  ? (s = l[r.attributes[n]](i, e, s))
                  : console.error('Unknown decoder for', r.attributes[n])
            else {
              let r = n.ordering,
              ...
              t.defined(o) &&
                ...
                ((r = Object.keys(o.geometryData[0].params.vertexAttributes)),
                (a = Object.keys(o.geometryData[0].params.featureAttributes)))
  ...
  function f(e, n, r, o, i) {
    ...
    const u = [
        ...
        function () {
          s = new e.DracoInt8Array(a)
          n.GetAttributeUInt8ForAllPoints(r, o, s) ||
        ...
        function () {
          ...
          n.GetAttributeInt16ForAllPoints(r, o, s) ||
            console.error('Bad stream')
        ...
        function () {
          s = new e.DracoInt16Array(a)
          n.GetAttributeUInt16ForAllPoints(r, o, s) ||
            console.error('Bad stream')
        ...
        function () {
          ...
          n.GetAttributeInt32ForAllPoints(r, o, s) ||
            console.error('Bad stream')
        ...
        function () {
          s = new e.DracoInt32Array(a)
          n.GetAttributeUInt32ForAllPoints(r, o, s) ||
            console.error('Bad stream')
        ...
        function () {
          ...
          n.GetAttributeFloatForAllPoints(r, o, s) ||
            console.error('Bad stream')
  ...
  function d(e) {
    ...
    t.defined(e.geoidDataList) &&
      ...
      (function (e, t, n, r, i, a, s) {
        ...
        for (let s = 0; s < e; ++s) {
          const e = u(
            i.longitude + o.CesiumMath.toRadians(n * t[3 * s]),
            i.latitude + o.CesiumMath.toRadians(r * t[3 * s + 1]),
            a
          )
          t[3 * s + 2] += e - c
        }
      ...
      (function (e, n, i, a, s, u, c, f, l) {
        ...
        for (let c = 0; c < e; ++c) {
          ...
          const p = {}
          d.cartographicToCartesian(b, p),
            (p.x -= s.x),
            (p.y -= s.y),
            (p.z -= s.z)
          const g = {}
          if (
            (r.Matrix3.multiplyByVector(u, p, g),
            (n[e] = g.x),
            (n[y] = g.y),
            (n[h] = g.z),
            t.defined(i))
            ...
            const t = new r.Cartesian3(i[e], i[y], i[h]),
              n = {}
            r.Matrix3.multiplyByVector(u, t, n),
              (i[e] = n.x),
              (i[y] = n.y),
              (i[h] = n.z)
          }
    ...
    if (t.defined(n['feature-index']))
      ...
      for (let e = 0; e < n.faceRange.length - 1; e += 2) {
        const t = e / 2,
          ...
          o = n.faceRange[e + 1]
        for (let e = r; e <= o; e++)
          (a.featureIndex[3 * e] = t),
            (a.featureIndex[3 * e + 1] = t),
            (a.featureIndex[3 * e + 2] = t)
      }
    }
