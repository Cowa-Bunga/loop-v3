define([
  ...
  ;(c.prototype.isPointVisible = function (t) {
    return C(
      this._ellipsoid.transformPositionToScaledSpace(t, u),
      this._cameraPositionInScaledSpace,
  ...
  ;(c.prototype.isScaledSpacePointVisiblePossiblyUnderEllipsoid = function (
    t,
    e
  ) {
  ...
  ;(c.prototype.computeHorizonCullingPointPossiblyUnderEllipsoid = function (
    t,
    e,
    i,
    o
    ...
    (c.prototype.computeHorizonCullingPointFromVertices = function (
      t,
      e,
      i,
      o,
    ...
    (c.prototype.computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid =
  ...
  c.prototype.computeHorizonCullingPointFromRectangle = function (t, o, r) {
    ...
    if (!(i.Cartesian3.magnitude(s.center) < 0.1 * o.minimumRadius))
      return this.computeHorizonCullingPoint(s.center, n, r)
  }
  ...
  function P(t, e) {
    return i.Cartesian3.equals(e, i.Cartesian3.ZERO)
      ? e
      : (t.transformPositionToScaledSpace(e, T), i.Cartesian3.normalize(T, T))
  }
  const b = {
  ...
  function G(t, e, r, n, s, c, u, d, l, m) {
    ...
    if (o.defined(e) && o.defined(r) && o.defined(n) && o.defined(s)) {
      const t = e.minimum,
        ...
        u = n - r
      ;(p =
        Math.max(i.Cartesian3.maximumComponent(c), u) < q - 1
          ? E.BITS12
          : E.NONE),
        (h = a.Matrix4.inverseTransformation(s, new a.Matrix4()))
  ...
  G.prototype.encode = function (t, e, o, n, c, u, d, l) {
    ...
    if (this.quantization === E.BITS12) {
      ;((o = a.Matrix4.multiplyByPoint(this.toScaledENU, o, H)).x =
        s.CesiumMath.clamp(o.x, 0, 1)),
    ...
    return (
      this.hasVertexNormals &&
        (t[e++] = r.AttributeCompression.octPackFloat(u)),
      this.hasGeodeticSurfaceNormals &&
        ((t[e++] = l.x), (t[e++] = l.y), (t[e++] = l.z)),
      e
    )
  }
  ...
  ;(G.prototype.addGeodeticSurfaceNormals = function (t, e, i) {
    ...
    (G.prototype.decodePosition = function (t, e, n) {
      if (
        ...
        ;(n.x = i.x), (n.y = i.y)
        const o = r.AttributeCompression.decompressTextureCoordinates(
          t[e + 1],
          A
        )
      ...
      return (
        ...
        (n.y = t[e + 1]),
        (n.z = t[e + 2]),
        i.Cartesian3.add(n, this.center, n)
      )
    }),
    ...
    (G.prototype.decodeHeight = function (t, e) {
      if (((e *= this.stride), this.quantization === E.BITS12)) {
        return (
          r.AttributeCompression.decompressTextureCoordinates(t[e + 1], A).y *
    ...
    (G.prototype.decodeWebMercatorT = function (t, e) {
      return (
        (e *= this.stride),
        this.quantization === E.BITS12
          ? r.AttributeCompression.decompressTextureCoordinates(t[e + 3], A).x
          : t[e + 6]
      )
    }),
  ...
  ;(G.prototype.getAttributes = function (t) {
    ...
    if (this.quantization === E.NONE) {
      ...
      s(U.compressed0, t ? 4 : 3),
        e && s(U.compressed1, 1),
        this.hasGeodeticSurfaceNormals && s(U.geodeticSurfaceNormal, 3)
    }
    return r
  }),
