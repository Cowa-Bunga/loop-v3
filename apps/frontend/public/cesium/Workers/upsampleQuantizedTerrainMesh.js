define([
  ...
  const w = {
    ...
    computeLineSegmentLineSegmentIntersection: function (
      ...
      return a >= 0 && a <= 1 && f >= 0 && f <= 1
        ? (s.defined(d) || (d = new n.Cartesian2()),
          (d.x = e + a * (i - e)),
          (d.y = t + a * (r - t)),
          d)
        : void 0
      ...
      if (o.isIndexed())
        ...
        if (s.defined(h[r])) o.newIndex = h[r]
          ...
          e.push(o.getU()),
            t.push(o.getV()),
            n.push(o.getH()),
            p && (i.push(o.getNormalX()), i.push(o.getNormalY())),
            (o.newIndex = s),
            (h[r] = s)
        }
      }
  ...
  return (
    ...
    p(function (e, s) {
      ...
      let he, oe
      for (
        re.push(new F()), re.push(new F()), re.push(new F()), ee = 0;
        ee < X.length;
        ee += 3
      ) {
        const e = X[ee],
          ...
          s = Z[t],
          r = Z[n]
        se[0].initializeIndexed(Z, j, q, Q, e),
          se[1].initializeIndexed(Z, j, q, Q, t),
          se[2].initializeIndexed(Z, j, q, Q, n)
          ...
          he >= h.length ||
            ...
            he >= h.length ||
              ...
              he >= h.length ||
                ...
                (oe = C.clipTriangleAtAxisAlignedThreshold(
                  B,
                  d,
                  re[0].getV(),
                  re[1].getV(),
      ...
      for (ze += m.length, ee = 0; ee < x.length; ++ee)
        Me[ze + ee] = (y * (x[ee] - ce)) / Te
