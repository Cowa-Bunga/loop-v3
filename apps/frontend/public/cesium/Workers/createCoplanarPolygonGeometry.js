define([
  ...
  function Q(e, t, i, c, p, d, h, x, C) {
    ...
    if (0 !== c) {
      ...
      if (((A = r.Matrix3.fromQuaternion(e, A)), t.tangent || t.bitangent)) {
        ...
        ;(x = r.Cartesian3.normalize(r.Matrix3.multiplyByVector(o, x, x), x)),
          t.bitangent &&
            (C = r.Cartesian3.normalize(r.Cartesian3.cross(h, x, C), C))
      }
    ...
    for (let e = 0; e < L; e++) {
      ...
      if (((F[R++] = n.x), (F[R++] = n.y), (F[R++] = n.z), t.st))
        if (s.defined(p) && p.positions.length === L)
          (V[B++] = p.positions[e].x), (V[B++] = p.positions[e].y)
        else {
    ...
    return (
      t.position &&
        (N.position = new l.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.DOUBLE,
          componentsPerAttribute: 3,
          values: F
        })),
      t.normal &&
        (N.normal = new l.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: v
        })),
      t.tangent &&
        (N.tangent = new l.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: E
        })),
      t.bitangent &&
        (N.bitangent = new l.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: T
        })),
      t.st &&
        (N.st = new l.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
  ...
  function j(e) {
    ...
    ;(this._vertexFormat = h.VertexFormat.clone(a)),
      ...
      (this.packedLength =
        ...
        (s.defined(n)
          ? d.PolygonGeometryLibrary.computeHierarchyPackedLength(
              n,
              o.Cartesian2
            )
          : 1) +
  ...
  ;(j.fromPositions = function (e) {
    ...
    (j.pack = function (e, t, n) {
      return (
        ...
        (n = d.PolygonGeometryLibrary.packPolygonHierarchy(
          e._polygonHierarchy,
          t,
          n,
          r.Cartesian3
  ...
  return (
    (j.unpack = function (e, t, n) {
      ...
      const a = d.PolygonGeometryLibrary.unpackPolygonHierarchy(
        e,
        t,
        r.Cartesian3
      )
      ...
      const y = e[t++],
        c =
          -1 === e[t]
            ? void 0
            : d.PolygonGeometryLibrary.unpackPolygonHierarchy(
                e,
                t,
                o.Cartesian2
              )
    ...
    (j.createGeometry = function (t) {
      ...
      let x = a.positions
      if (
        ((x = e.arrayRemoveDuplicates(x, r.Cartesian3.equalsEpsilon, !0)),
        x.length < 3)
      )
        return
      let C = V,
      ...
      if (
        ...
        !r.Cartesian3.equalsEpsilon(
          I,
          r.Cartesian3.ZERO,
          m.CesiumMath.EPSILON6
        ))
      ) {
        const e = t._ellipsoid.geodeticSurfaceNormal(I, N)
        r.Cartesian3.dot(C, e) < 0 &&
          ((C = r.Cartesian3.negate(C, C)), (P = r.Cartesian3.negate(P, P)))
      }
      const w =
        ...
        L = i.CoplanarPolygonGeometryLibrary.createProjectPointTo2DFunction(
          I,
          P,
          A
        )
      o.tangent && (b = r.Cartesian3.clone(P, b)),
        o.bitangent && (f = r.Cartesian3.clone(A, f))
      ...
      for (let e = 0; e < v.length; e++) {
        const t = new c.GeometryInstance({
          geometry: Q(v[e], o, k, y, h ? E[e] : void 0, L, C, b, f)
        })
        D.push(t)
      }
      ...
      ;(O.attributes.position.values = new Float64Array(
        ...
        (O.indices = u.IndexDatatype.createTypedArray(
          O.attributes.position.values.length / 3,
          O.indices
        ))
      const z = O.attributes
      return (
        o.position || delete z.position,
        new l.Geometry({
          attributes: z,
          indices: O.indices,
