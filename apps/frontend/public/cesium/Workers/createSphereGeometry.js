define([
  ...
  function G(r) {
    ...
    ;(this._ellipsoidGeometry = new i.EllipsoidGeometry(a)),
  ...
  return (
    (G.unpack = function (o, a, n) {
      ...
      return (
        (k.vertexFormat = r.VertexFormat.clone(
          s._vertexFormat,
          k.vertexFormat
        )),
        ...
        e.defined(n)
          ? (t.Cartesian3.clone(s._radii, k.radii),
            (n._ellipsoidGeometry = new i.EllipsoidGeometry(k)),
            n)
