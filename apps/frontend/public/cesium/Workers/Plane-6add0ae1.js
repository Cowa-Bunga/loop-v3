define([
  ...
  r.fromPointNormal = function (n, a, i) {
    ...
    return t.defined(i)
      ? (e.Cartesian3.clone(a, i.normal), (i.distance = s), i)
      : new r(a, s)
  }
  ...
  ;(r.fromCartesian4 = function (n, a) {
    const s = e.Cartesian3.fromCartesian4(n, i),
      o = n.w
    return t.defined(a)
      ? (e.Cartesian3.clone(s, a.normal), (a.distance = o), a)
      : new r(s, o)
  }),
  ...
  ;(r.transform = function (n, t, i) {
    ...
    return (
      (f = a.Cartesian4.divideByScalar(f, e.Cartesian3.magnitude(u), f)),
      r.fromCartesian4(f, i)
    )
  }),
    (r.clone = function (n, a) {
      return t.defined(a)
        ? (e.Cartesian3.clone(n.normal, a.normal), (a.distance = n.distance), a)
        : new r(n.normal, n.distance)
    }),
