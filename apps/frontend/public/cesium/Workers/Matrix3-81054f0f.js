define(['exports', './defaultValue-f6d5e6da', './Math-2ce22ee9'], function (
  e,
  t,
  n
) {
  ...
  i.lerp = function (e, t, n, r) {
    return (
      i.multiplyByScalar(t, n, a),
      (r = i.multiplyByScalar(e, 1 - n, r)),
      i.add(a, r, r)
    )
  }
  const o = new i(),
  ...
  ;(i.fromRadians = function (e, n, r, a, o) {
    ...
    ;(s.x = c * Math.cos(e)),
      ...
      (s.z = Math.sin(n)),
      (s = i.normalize(s, s)),
      i.multiplyComponents(u, s, d)
    const f = Math.sqrt(i.dot(s, d))
    return (
      (d = i.divideByScalar(d, f, d)),
      (s = i.multiplyByScalar(s, r, s)),
      t.defined(o) || (o = new i()),
      i.add(d, s, o)
    )
  }),
  ...
  ;(y.fromRadians = function (e, n, i, r) {
    return (
      (i = t.defaultValue(i, 0)),
      t.defined(r)
        ? ((r.longitude = e), (r.latitude = n), (r.height = i), r)
        : new y(e, n, i)
    )
  }),
  ...
  function S(e, r, a, o) {
    ;(r = t.defaultValue(r, 0)),
      ...
      (e._radiiToTheFourth = new i(
        r * r * r * r,
        a * a * a * a,
        o * o * o * o
      )),
      (e._oneOverRadii = new i(
        0 === r ? 0 : 1 / r,
        0 === a ? 0 : 1 / a,
        0 === o ? 0 : 1 / o
      )),
      (e._oneOverRadiiSquared = new i(
        0 === r ? 0 : 1 / (r * r),
        0 === a ? 0 : 1 / (a * a),
        0 === o ? 0 : 1 / (o * o)
      )),
  ...
  ;(y.fromCartesian = function (e, r, a) {
    ...
    return t.defined(a)
      ? ((a.longitude = l), (a.latitude = f), (a.height = h), a)
      : new y(l, f, h)
  }),
    ...
    (q.prototype.geodeticSurfaceNormal = function (e, r) {
      if (!i.equalsEpsilon(e, i.ZERO, n.CesiumMath.EPSILON14))
        return (
          t.defined(r) || (r = new i()),
          (r = i.multiplyComponents(e, this._oneOverRadiiSquared, r)),
          i.normalize(r, r)
        )
    })
  const R = new i(),
  ...
  ;(q.prototype.cartographicToCartesian = function (e, n) {
    ...
    return (
      i.divideByScalar(a, o, a),
      i.multiplyByScalar(r, e.height, r),
      t.defined(n) || (n = new i()),
      i.add(a, r, n)
    )
  }),
    (q.prototype.cartographicArrayToCartesianArray = function (e, n) {
      ...
      for (let t = 0; t < i; t++)
        n[t] = this.cartographicToCartesian(e[t], n[t])
      return n
    })
  const O = new i(),
    C = new i(),
  ...
  ;(q.prototype.cartesianToCartographic = function (e, r) {
    ...
    return t.defined(r)
      ? ((r.longitude = c), (r.latitude = s), (r.height = d), r)
      : new y(c, s, d)
  }),
    (q.prototype.cartesianArrayToCartographicArray = function (e, n) {
      ...
      t.defined(n) ? (n.length = i) : (n = new Array(i))
      for (let t = 0; t < i; ++t)
        n[t] = this.cartesianToCartographic(e[t], n[t])
      return n
    }),
    ...
    (q.prototype.transformPositionToScaledSpace = function (e, n) {
      return (
        t.defined(n) || (n = new i()),
        i.multiplyComponents(e, this._oneOverRadii, n)
      )
    }),
    (q.prototype.transformPositionFromScaledSpace = function (e, n) {
      return (
        t.defined(n) || (n = new i()), i.multiplyComponents(e, this._radii, n)
      )
    }),
  ...
  ;(q.prototype.surfaceArea = function (e) {
    ...
    (v.setColumn = function (e, t, n, i) {
      const r = 3 * t
      return (
        ((i = v.clone(e, i))[r] = n.x), (i[r + 1] = n.y), (i[r + 2] = n.z), i
      )
    }),
    ...
    (v.setRow = function (e, t, n, i) {
      return (
        ((i = v.clone(e, i))[t] = n.x), (i[t + 3] = n.y), (i[t + 6] = n.z), i
      )
    })
  const N = new i()
  ...
  function P(e, t) {
    ...
    if (Math.abs(e[v.getElementIndex(s, c)]) > i) {
      const t =
        (e[v.getElementIndex(s, s)] - e[v.getElementIndex(c, c)]) /
        2 /
        e[v.getElementIndex(s, c)]
      let n
      ;(n =
        t < 0
          ? -1 / (-t + Math.sqrt(1 + t * t))
    ...
    return (
      ((t = v.clone(v.IDENTITY, t))[v.getElementIndex(c, c)] = t[
        v.getElementIndex(s, s)
      ] =
        o),
