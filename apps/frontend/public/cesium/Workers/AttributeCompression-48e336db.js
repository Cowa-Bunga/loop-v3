define([
    ...
    i = {
      octEncodeInRange: function (t, e, n) {
        if (
          ...
          const t = n.x,
            e = n.y
          ;(n.x = (1 - Math.abs(e)) * r.CesiumMath.signNotZero(t)),
            (n.y = (1 - Math.abs(t)) * r.CesiumMath.signNotZero(e))
        }
        return (
          (n.x = r.CesiumMath.toSNorm(n.x, e)),
          (n.y = r.CesiumMath.toSNorm(n.y, e)),
          n
        )
      },
  ...
  ;(i.octEncodeToCartesian4 = function (t, e) {
    ...
    (i.octDecodeInRange = function (t, e, o, a) {
      if (
        ((a.x = r.CesiumMath.fromSNorm(t, o)),
        (a.y = r.CesiumMath.fromSNorm(e, o)),
        (a.z = 1 - (Math.abs(a.x) + Math.abs(a.y))),
        a.z < 0)
      ) {
        const t = a.x
        ;(a.x = (1 - Math.abs(a.y)) * r.CesiumMath.signNotZero(t)),
          (a.y = (1 - Math.abs(t)) * r.CesiumMath.signNotZero(a.y))
      }
