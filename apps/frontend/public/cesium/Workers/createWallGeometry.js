define([
  ...
  return (
    ...
    (L.createGeometry = function (l) {
      ...
      for (T = 0; T < L; ++T) {
        ...
        if (
          ...
          if ((T + 1 < L && (i = t.Cartesian3.fromArray(C, e + 3, b)), B)) {
            ...
            ;(M = t.Cartesian3.normalize(t.Cartesian3.cross(o, e, M), M)),
              (B = !1)
          }
          t.Cartesian3.equalsEpsilon(n, i, s.CesiumMath.EPSILON10)
            ...
            : ((U += q),
              d.tangent &&
                (N = t.Cartesian3.normalize(t.Cartesian3.subtract(i, n, N), N)),
              d.bitangent &&
                (W = t.Cartesian3.normalize(t.Cartesian3.cross(M, N, W), W))),
            d.normal &&
              ((H[O++] = M.x),
              (H[O++] = M.y),
              (H[O++] = M.z),
      ...
      d.position &&
        (J.position = new a.GeometryAttribute({
          componentDatatype: i.ComponentDatatype.DOUBLE,
          componentsPerAttribute: 3,
          values: k
        })),
        d.normal &&
          (J.normal = new a.GeometryAttribute({
            componentDatatype: i.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: H
          })),
        d.tangent &&
          (J.tangent = new a.GeometryAttribute({
            componentDatatype: i.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: D
          })),
        d.bitangent &&
          (J.bitangent = new a.GeometryAttribute({
            componentDatatype: i.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: G
          })),
        d.st &&
          (J.st = new a.GeometryAttribute({
            componentDatatype: i.ComponentDatatype.FLOAT,
