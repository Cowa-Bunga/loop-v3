define([
  ...
  ;(y.packedLength = i.VertexFormat.packedLength),
    (y.pack = function (e, n, r) {
      return (
        ...
        i.VertexFormat.pack(e._vertexFormat, n, r),
        n
      )
    })
  ...
  y.unpack = function (e, n, r) {
    ...
    return t.defined(r)
      ? ((r._vertexFormat = i.VertexFormat.clone(a, r._vertexFormat)), r)
      : new y(A)
  }
    ...
    (y.createGeometry = function (t) {
      ...
      if (i.position) {
        if (
          ...
          (p[10] = f.y),
          (p[11] = 0),
          (m.position = new a.GeometryAttribute({
          ...
          ;(t[0] = 0),
            ...
            (t[10] = 0),
            (t[11] = 1),
            (m.normal = new a.GeometryAttribute({
        ...
        if (i.tangent) {
          ...
          ;(t[0] = 1),
            ...
            (t[10] = 0),
            (t[11] = 0),
            (m.tangent = new a.GeometryAttribute({
              componentDatatype: r.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: t
            }))
        ...
        if (i.bitangent) {
          ...
          ;(t[0] = 0),
            ...
            (t[10] = 1),
            (t[11] = 0),
            (m.bitangent = new a.GeometryAttribute({
              componentDatatype: r.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: t
            }))
