define([
  ...
  function N(e, r, i, o, l, c, C, u) {
    let d = V,
      g = I
    ;(A = s.Transforms.eastNorthUpToFixedFrame(e, l, A)),
      (d = a.Matrix4.multiplyByPointAsVector(A, S, d)),
      (d = t.Cartesian3.normalize(d, d))
    ...
    ;(R = t.Matrix3.fromRotationZ(y, R)),
      (v.z = c),
      (A = a.Matrix4.multiplyTransformation(
        A,
        a.Matrix4.fromRotationTranslation(R, v, D),
        A
      ))
    const h = O
    h[0] = C
  ...
  function F(e, a, n, i, o, c, C, u, d, g) {
    const y = t.Cartesian3.angleBetween(
        t.Cartesian3.subtract(a, e, E),
        t.Cartesian3.subtract(n, e, P)
      ),
    ...
    if (
      ((m = o
        ...
        : t.Matrix3.fromQuaternion(
            s.Quaternion.fromAxisAngle(e, y / (h + 1), j),
            q
          )),
  ...
  M.computePositions = function (e, a, n, s, o) {
    const c = s._ellipsoid,
      P = (function (e, a) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n]
          ;(T = a.cartesianToCartographic(r, T)),
            (t[n] = T.height),
            (e[n] = a.scaleToGeodeticSurface(r, r))
        }
        return t
      })(e, c),
      B = s._granularity,
    ...
    let X,
      ...
      ee = P[0],
      ae = P[1]
    o && (I = N(J, Y, A, I, c, ee + D, 1, 1)),
      (k = t.Cartesian3.clone(J, k)),
      (J = K),
    ...
    for (let a = 1; a < O - 1; a++) {
      ...
      if (
        !r.CesiumMath.equalsEpsilon(
          Math.abs(t.Cartesian3.dot(s, d)),
          1,
          r.CesiumMath.EPSILON7
        )
      ) {
        ;(j = t.Cartesian3.cross(j, Q, j)),
          (j = t.Cartesian3.cross(Q, j, j)),
          (j = t.Cartesian3.normalize(j, j))
        const e =
            1 /
            Math.max(0.25, t.Cartesian3.magnitude(t.Cartesian3.cross(j, G, E))),
          a = M.angleIsGreaterThanPi(v, G, J, c)
        a
          ? ((q = t.Cartesian3.add(
              J,
              t.Cartesian3.multiplyByScalar(j, e * R, j),
              q
            )),
            (Z = t.Cartesian3.add(
              q,
              t.Cartesian3.multiplyByScalar(Y, R, Z),
              Z
            )),
            ...
            (W = t.Cartesian3.add(
              q,
              t.Cartesian3.multiplyByScalar(Y, R, W),
              W
            )),
            z === l.ROUNDED || z === l.BEVELED
              ? F(q, Z, W, z, a, c, V, S, ae + D, o)
              : ((j = t.Cartesian3.negate(j, j)),
                (V = N(J, j, S, V, c, ae + D, e, n))),
  ...
  var Z = M
  ;(e.CornerType = l),
    (e.PolylineVolumeGeometryLibrary = Z),
    (e.oneTimeWarning = C)
})
