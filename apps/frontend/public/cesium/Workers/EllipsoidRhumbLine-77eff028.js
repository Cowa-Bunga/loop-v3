define([
    ...
    return (
      ...
      ((1 -
        ...
        ((35 * s) / 3072 +
          ...
          (13475 * o) / 1048576) *
          Math.sin(6 * l) +
        ((315 * h) / 131072 + (2205 * u) / 524288 + (43659 * o) / 8388608) *
          Math.sin(8 * l) -
  ...
  const h = new i.Cartesian3(),
    u = new i.Cartesian3()
  function o(t, e, o, l) {
    i.Cartesian3.normalize(l.cartographicToCartesian(e, u), h),
      i.Cartesian3.normalize(l.cartographicToCartesian(o, u), u)
      ...
      (t._distance = (function (t, i, e, s, h, u, o) {
        ...
        if (
          ...
          if (i === e) d = i * Math.cos(h) * a.CesiumMath.negativePiToPi(r)
            ...
            const e = Math.sin(h)
            d =
              (i * Math.cos(h) * a.CesiumMath.negativePiToPi(r)) /
  ...
  function l(t, h, u, o, l, r) {
    ...
    let c, M, g
    if (
      Math.abs(a.CesiumMath.PI_OVER_TWO - Math.abs(h)) > a.CesiumMath.EPSILON8
    ) {
      M = (function (t, i, e) {
        const a = t / e
        if (0 === i) return a
      ...
      const i = s(l, t.latitude),
        e = s(l, M)
      ;(g = Math.tan(h) * (e - i)),
        (c = a.CesiumMath.negativePiToPi(t.longitude + g))
    } else {
      let i
      ...
      ;(g = u / i),
        (c =
          h > 0
            ? a.CesiumMath.negativePiToPi(t.longitude + g)
            : a.CesiumMath.negativePiToPi(t.longitude - g))
    }
    return e.defined(r)
  ...
  Object.defineProperties(r.prototype, {
    ...
    (r.fromStartHeadingDistance = function (t, n, s, h, u) {
      ...
      return !e.defined(u) || (e.defined(h) && !h.equals(u.ellipsoid))
        ? new r(t, _, o)
    ...
    (r.prototype.findIntersectionWithLongitude = function (t, n) {
      ...
      if (
        ...
        ) && (t = a.CesiumMath.sign(o.longitude) * Math.PI),
      ...
      if (
        a.CesiumMath.equalsEpsilon(
          Math.abs(a.CesiumMath.PI_OVER_TWO - u),
          a.CesiumMath.PI_OVER_TWO,
          a.CesiumMath.EPSILON8
        )
      ) {
        if (a.CesiumMath.equalsEpsilon(t, o.longitude, a.CesiumMath.EPSILON12))
          return
        return (
          (n.longitude = t),
          (n.latitude =
            a.CesiumMath.PI_OVER_TWO *
            a.CesiumMath.sign(a.CesiumMath.PI_OVER_TWO - h)),
          (n.height = 0),
          n
        )
      }
      const l = o.latitude,
        ...
        d =
          ...
          Math.exp((t - o.longitude) / Math.tan(h)),
        c = (1 + r) / (1 - r)
      let M,
        g = o.latitude
      do {
    ...
    (r.prototype.findIntersectionWithLatitude = function (t, n) {
      ...
      return e.defined(n)
        ? ((n.longitude = c), (n.latitude = t), (n.height = 0), n)
