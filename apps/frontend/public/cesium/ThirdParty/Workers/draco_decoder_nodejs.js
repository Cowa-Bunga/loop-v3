...
;($jscomp.scope = {}),
  ...
  ($jscomp.defineProperty =
    $jscomp.ASSUME_ES5 || typeof Object.defineProperties == 'function'
      ...
      : function (p, s, a) {
          return (
            p == Array.prototype || p == Object.prototype || (p[s] = a.value), p
          )
        }),
...
;($jscomp.polyfill = function (p, s, a, c) {
  s &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(p, s, a, c)
      : $jscomp.polyfillUnisolated(p, s, a, c))
}),
  ...
  ($jscomp.polyfillIsolated = function (p, s, a, c) {
    ...
    ;(p = i.length === 1),
      (c = i[0]),
      (c = !p && c in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global)
    ...
    function (p) {
      ...
      return (
        ...
        (i.race = function (_) {
          return new i(function (y, b) {
            for (
              var D = $jscomp.makeIterator(_), L = D.next();
              !L.done;
              L = D.next()
            )
              a(L.value).callWhenSettled_(y, b)
          })
        }),
        (i.all = function (_) {
          ...
          return b.done
            ...
            : new i(function (D, L) {
                ...
                do
                  m.push(void 0),
                    A++,
                    a(b.value).callWhenSettled_(X(m.length - 1), L),
                    (b = y.next())
                while (!b.done)
              })
        }),
      ...
      return (
        ...
        function (a, c, i) {
          ...
          if (
            ...
            for (i = Math.min(i, I + c - a), a += i - c; i > c; )
              --i in this ? (this[--a] = this[i]) : delete this[--a]
          return this
        }
      )
    },
  ...
  return (
    ...
    function (s) {
      ...
      ;(t.onRuntimeInitialized = function () {
        ;(ft = !0),
          dt && typeof t.onModuleLoaded == 'function' && t.onModuleLoaded(t)
      }),
        (t.onModuleParsed = function () {
          ;(dt = !0),
            ft && typeof t.onModuleLoaded == 'function' && t.onModuleLoaded(t)
        }),
      ...
      if (At) {
        ...
        var Dt = function (e, r) {
            return (
              ...
              Tt.readFileSync(e, r ? void 0 : 'utf8')
            )
          },
          pt = function (e) {
      ...
      var Ot = (t._emscripten_bind_VoidPtr___destroy___0 = function () {
          return (Ot = t._emscripten_bind_VoidPtr___destroy___0 =
            t.asm.k).apply(null, arguments)
        }),
        jt = (t._emscripten_bind_DecoderBuffer_DecoderBuffer_0 = function () {
          return (jt = t._emscripten_bind_DecoderBuffer_DecoderBuffer_0 =
            t.asm.l).apply(null, arguments)
        }),
        Pt = (t._emscripten_bind_DecoderBuffer_Init_2 = function () {
          return (Pt = t._emscripten_bind_DecoderBuffer_Init_2 = t.asm.m).apply(
            null,
            arguments
          )
        }),
        Rt = (t._emscripten_bind_DecoderBuffer___destroy___0 = function () {
          return (Rt = t._emscripten_bind_DecoderBuffer___destroy___0 =
        ...
        Mt = (t._emscripten_bind_AttributeTransformData_transform_type_0 =
          function () {
            return (Mt =
              t._emscripten_bind_AttributeTransformData_transform_type_0 =
                t.asm.p).apply(null, arguments)
          }),
        Nt = (t._emscripten_bind_AttributeTransformData___destroy___0 =
          function () {
            return (Nt =
        ...
        Ft = (t._emscripten_bind_GeometryAttribute___destroy___0 = function () {
          return (Ft = t._emscripten_bind_GeometryAttribute___destroy___0 =
            t.asm.s).apply(null, arguments)
        }),
        Lt = (t._emscripten_bind_PointAttribute_PointAttribute_0 = function () {
          return (Lt = t._emscripten_bind_PointAttribute_PointAttribute_0 =
            t.asm.t).apply(null, arguments)
        }),
        Ct = (t._emscripten_bind_PointAttribute_size_0 = function () {
          return (Ct = t._emscripten_bind_PointAttribute_size_0 =
        ...
        $t = (t._emscripten_bind_AttributeQuantizationTransform___destroy___0 =
          function () {
            return ($t =
        ...
        ne = (t._emscripten_bind_PointCloud_PointCloud_0 = function () {
          return (ne = t._emscripten_bind_PointCloud_PointCloud_0 =
            t.asm.O).apply(null, arguments)
        }),
        oe = (t._emscripten_bind_PointCloud_num_attributes_0 = function () {
          return (oe = t._emscripten_bind_PointCloud_num_attributes_0 =
            t.asm.P).apply(null, arguments)
        }),
        _e = (t._emscripten_bind_PointCloud_num_points_0 = function () {
          return (_e = t._emscripten_bind_PointCloud_num_points_0 =
            t.asm.Q).apply(null, arguments)
        }),
        ie = (t._emscripten_bind_PointCloud___destroy___0 = function () {
          return (ie = t._emscripten_bind_PointCloud___destroy___0 =
            t.asm.R).apply(null, arguments)
        }),
        pe = (t._emscripten_bind_Mesh_Mesh_0 = function () {
          return (pe = t._emscripten_bind_Mesh_Mesh_0 = t.asm.S).apply(
            null,
            arguments
          )
        }),
        ae = (t._emscripten_bind_Mesh_num_faces_0 = function () {
          return (ae = t._emscripten_bind_Mesh_num_faces_0 = t.asm.T).apply(
            null,
            arguments
          )
        }),
        ue = (t._emscripten_bind_Mesh_num_attributes_0 = function () {
          return (ue = t._emscripten_bind_Mesh_num_attributes_0 =
            t.asm.U).apply(null, arguments)
        }),
        se = (t._emscripten_bind_Mesh_num_points_0 = function () {
          return (se = t._emscripten_bind_Mesh_num_points_0 = t.asm.V).apply(
            null,
            arguments
          )
        }),
        ce = (t._emscripten_bind_Mesh___destroy___0 = function () {
          return (ce = t._emscripten_bind_Mesh___destroy___0 = t.asm.W).apply(
            null,
            arguments
          )
        }),
        ye = (t._emscripten_bind_Metadata_Metadata_0 = function () {
          return (ye = t._emscripten_bind_Metadata_Metadata_0 = t.asm.X).apply(
            null,
            arguments
          )
        }),
        le = (t._emscripten_bind_Metadata___destroy___0 = function () {
          return (le = t._emscripten_bind_Metadata___destroy___0 =
            t.asm.Y).apply(null, arguments)
        }),
        me = (t._emscripten_bind_Status_code_0 = function () {
          return (me = t._emscripten_bind_Status_code_0 = t.asm.Z).apply(
            null,
            arguments
          )
        }),
        fe = (t._emscripten_bind_Status_ok_0 = function () {
          return (fe = t._emscripten_bind_Status_ok_0 = t.asm._).apply(
            null,
            arguments
          )
        }),
        de = (t._emscripten_bind_Status_error_msg_0 = function () {
          return (de = t._emscripten_bind_Status_error_msg_0 = t.asm.$).apply(
            null,
            arguments
          )
        }),
        be = (t._emscripten_bind_Status___destroy___0 = function () {
          return (be = t._emscripten_bind_Status___destroy___0 =
            t.asm.aa).apply(null, arguments)
        }),
        he = (t._emscripten_bind_DracoFloat32Array_DracoFloat32Array_0 =
          function () {
            return (he =
        ...
        xe = (t._emscripten_bind_DracoUInt32Array_GetValue_1 = function () {
          return (xe = t._emscripten_bind_DracoUInt32Array_GetValue_1 =
            t.asm.Aa).apply(null, arguments)
        }),
        Qe = (t._emscripten_bind_DracoUInt32Array_size_0 = function () {
          return (Qe = t._emscripten_bind_DracoUInt32Array_size_0 =
            t.asm.Ba).apply(null, arguments)
        }),
        Ye = (t._emscripten_bind_DracoUInt32Array___destroy___0 = function () {
          return (Ye = t._emscripten_bind_DracoUInt32Array___destroy___0 =
            t.asm.Ca).apply(null, arguments)
        }),
        He = (t._emscripten_bind_MetadataQuerier_MetadataQuerier_0 =
          function () {
            return (He = t._emscripten_bind_MetadataQuerier_MetadataQuerier_0 =
              t.asm.Da).apply(null, arguments)
          }),
        qe = (t._emscripten_bind_MetadataQuerier_HasEntry_2 = function () {
          return (qe = t._emscripten_bind_MetadataQuerier_HasEntry_2 =
            t.asm.Ea).apply(null, arguments)
        }),
        ...
        Xe = (t._emscripten_bind_MetadataQuerier_GetIntEntryArray_3 =
          function () {
            return (Xe = t._emscripten_bind_MetadataQuerier_GetIntEntryArray_3 =
              t.asm.Ga).apply(null, arguments)
          }),
        Ke = (t._emscripten_bind_MetadataQuerier_GetDoubleEntry_2 =
          function () {
            return (Ke = t._emscripten_bind_MetadataQuerier_GetDoubleEntry_2 =
              t.asm.Ha).apply(null, arguments)
          }),
        Je = (t._emscripten_bind_MetadataQuerier_GetStringEntry_2 =
          function () {
            return (Je = t._emscripten_bind_MetadataQuerier_GetStringEntry_2 =
              t.asm.Ia).apply(null, arguments)
          }),
        $e = (t._emscripten_bind_MetadataQuerier_NumEntries_1 = function () {
          return ($e = t._emscripten_bind_MetadataQuerier_NumEntries_1 =
            t.asm.Ja).apply(null, arguments)
        }),
        Ze = (t._emscripten_bind_MetadataQuerier_GetEntryName_2 = function () {
          return (Ze = t._emscripten_bind_MetadataQuerier_GetEntryName_2 =
            t.asm.Ka).apply(null, arguments)
        }),
        tr = (t._emscripten_bind_MetadataQuerier___destroy___0 = function () {
          return (tr = t._emscripten_bind_MetadataQuerier___destroy___0 =
            t.asm.La).apply(null, arguments)
        }),
        er = (t._emscripten_bind_Decoder_Decoder_0 = function () {
          return (er = t._emscripten_bind_Decoder_Decoder_0 = t.asm.Ma).apply(
            null,
            arguments
          )
        }),
        rr = (t._emscripten_bind_Decoder_DecodeArrayToPointCloud_3 =
          function () {
            return (rr = t._emscripten_bind_Decoder_DecodeArrayToPointCloud_3 =
              t.asm.Na).apply(null, arguments)
          }),
        nr = (t._emscripten_bind_Decoder_DecodeArrayToMesh_3 = function () {
          return (nr = t._emscripten_bind_Decoder_DecodeArrayToMesh_3 =
            t.asm.Oa).apply(null, arguments)
        }),
        or = (t._emscripten_bind_Decoder_GetAttributeId_2 = function () {
          return (or = t._emscripten_bind_Decoder_GetAttributeId_2 =
            t.asm.Pa).apply(null, arguments)
        }),
        _r = (t._emscripten_bind_Decoder_GetAttributeIdByName_2 = function () {
          return (_r = t._emscripten_bind_Decoder_GetAttributeIdByName_2 =
            t.asm.Qa).apply(null, arguments)
        }),
        ir = (t._emscripten_bind_Decoder_GetAttributeIdByMetadataEntry_3 =
          function () {
            return (ir =
        ...
        pr = (t._emscripten_bind_Decoder_GetAttribute_2 = function () {
          return (pr = t._emscripten_bind_Decoder_GetAttribute_2 =
            t.asm.Sa).apply(null, arguments)
        }),
        ar = (t._emscripten_bind_Decoder_GetAttributeByUniqueId_2 =
          function () {
            return (ar = t._emscripten_bind_Decoder_GetAttributeByUniqueId_2 =
              t.asm.Ta).apply(null, arguments)
          }),
        ur = (t._emscripten_bind_Decoder_GetMetadata_1 = function () {
          return (ur = t._emscripten_bind_Decoder_GetMetadata_1 =
            t.asm.Ua).apply(null, arguments)
        }),
        sr = (t._emscripten_bind_Decoder_GetAttributeMetadata_2 = function () {
          return (sr = t._emscripten_bind_Decoder_GetAttributeMetadata_2 =
            t.asm.Va).apply(null, arguments)
        }),
        cr = (t._emscripten_bind_Decoder_GetFaceFromMesh_3 = function () {
          return (cr = t._emscripten_bind_Decoder_GetFaceFromMesh_3 =
            t.asm.Wa).apply(null, arguments)
        }),
        yr = (t._emscripten_bind_Decoder_GetTriangleStripsFromMesh_2 =
          function () {
            return (yr =
              t._emscripten_bind_Decoder_GetTriangleStripsFromMesh_2 =
                t.asm.Xa).apply(null, arguments)
          }),
        lr = (t._emscripten_bind_Decoder_GetTrianglesUInt16Array_3 =
          function () {
            return (lr = t._emscripten_bind_Decoder_GetTrianglesUInt16Array_3 =
              t.asm.Ya).apply(null, arguments)
          }),
        mr = (t._emscripten_bind_Decoder_GetTrianglesUInt32Array_3 =
          function () {
            return (mr = t._emscripten_bind_Decoder_GetTrianglesUInt32Array_3 =
              t.asm.Za).apply(null, arguments)
          }),
        fr = (t._emscripten_bind_Decoder_GetAttributeFloat_3 = function () {
          return (fr = t._emscripten_bind_Decoder_GetAttributeFloat_3 =
        ...
        Ar = (t._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 =
          function () {
            return (Ar =
              t._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 =
                t.asm.cb).apply(null, arguments)
          }),
        Tr = (t._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 =
          function () {
            return (Tr =
        ...
        vr = (t._emscripten_bind_Decoder_GetAttributeDataArrayForAllPoints_5 =
          function () {
            return (vr =
              t._emscripten_bind_Decoder_GetAttributeDataArrayForAllPoints_5 =
                t.asm.hb).apply(null, arguments)
          }),
        Er = (t._emscripten_bind_Decoder_SkipAttributeTransform_1 =
          function () {
            return (Er = t._emscripten_bind_Decoder_SkipAttributeTransform_1 =
              t.asm.ib).apply(null, arguments)
          }),
        Gr = (t._emscripten_bind_Decoder_GetEncodedGeometryType_Deprecated_1 =
          function () {
            return (Gr =
        ...
        Or = (t._emscripten_bind_Decoder_DecodeBufferToPointCloud_2 =
          function () {
            return (Or = t._emscripten_bind_Decoder_DecodeBufferToPointCloud_2 =
              t.asm.kb).apply(null, arguments)
          }),
        jr = (t._emscripten_bind_Decoder_DecodeBufferToMesh_2 = function () {
          return (jr = t._emscripten_bind_Decoder_DecodeBufferToMesh_2 =
            t.asm.lb).apply(null, arguments)
        }),
        Pr = (t._emscripten_bind_Decoder___destroy___0 = function () {
          return (Pr = t._emscripten_bind_Decoder___destroy___0 =
        ...
        Fr = (t._emscripten_enum_draco_GeometryAttribute_Type_POSITION =
          function () {
            return (Fr =
              t._emscripten_enum_draco_GeometryAttribute_Type_POSITION =
                t.asm.sb).apply(null, arguments)
          }),
        Lr = (t._emscripten_enum_draco_GeometryAttribute_Type_NORMAL =
          function () {
            return (Lr =
        ...
        Cr = (t._emscripten_enum_draco_GeometryAttribute_Type_COLOR =
          function () {
            return (Cr = t._emscripten_enum_draco_GeometryAttribute_Type_COLOR =
        ...
        Br = (t._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD =
          function () {
            return (Br =
              t._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD =
                t.asm.yb).apply(null, arguments)
          }),
        Wr = (t._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH =
          function () {
            return (Wr =
        ...
        xr = (t._emscripten_enum_draco_DataType_DT_INVALID = function () {
          return (xr = t._emscripten_enum_draco_DataType_DT_INVALID =
            t.asm.Ab).apply(null, arguments)
        }),
        ...
        Yr = (t._emscripten_enum_draco_DataType_DT_UINT8 = function () {
          return (Yr = t._emscripten_enum_draco_DataType_DT_UINT8 =
            t.asm.Cb).apply(null, arguments)
        }),
        Hr = (t._emscripten_enum_draco_DataType_DT_INT16 = function () {
          return (Hr = t._emscripten_enum_draco_DataType_DT_INT16 =
            t.asm.Db).apply(null, arguments)
        }),
        qr = (t._emscripten_enum_draco_DataType_DT_UINT16 = function () {
          return (qr = t._emscripten_enum_draco_DataType_DT_UINT16 =
            t.asm.Eb).apply(null, arguments)
        }),
        kr = (t._emscripten_enum_draco_DataType_DT_INT32 = function () {
          return (kr = t._emscripten_enum_draco_DataType_DT_INT32 =
            t.asm.Fb).apply(null, arguments)
        }),
        Xr = (t._emscripten_enum_draco_DataType_DT_UINT32 = function () {
          return (Xr = t._emscripten_enum_draco_DataType_DT_UINT32 =
            t.asm.Gb).apply(null, arguments)
        }),
        Kr = (t._emscripten_enum_draco_DataType_DT_INT64 = function () {
          return (Kr = t._emscripten_enum_draco_DataType_DT_INT64 =
            t.asm.Hb).apply(null, arguments)
        }),
        Jr = (t._emscripten_enum_draco_DataType_DT_UINT64 = function () {
          return (Jr = t._emscripten_enum_draco_DataType_DT_UINT64 =
            t.asm.Ib).apply(null, arguments)
        }),
        $r = (t._emscripten_enum_draco_DataType_DT_FLOAT32 = function () {
          return ($r = t._emscripten_enum_draco_DataType_DT_FLOAT32 =
            t.asm.Jb).apply(null, arguments)
        }),
        Zr = (t._emscripten_enum_draco_DataType_DT_FLOAT64 = function () {
          return (Zr = t._emscripten_enum_draco_DataType_DT_FLOAT64 =
            t.asm.Kb).apply(null, arguments)
        }),
        tn = (t._emscripten_enum_draco_DataType_DT_BOOL = function () {
          return (tn = t._emscripten_enum_draco_DataType_DT_BOOL =
            t.asm.Lb).apply(null, arguments)
        }),
        en = (t._emscripten_enum_draco_DataType_DT_TYPES_COUNT = function () {
          return (en = t._emscripten_enum_draco_DataType_DT_TYPES_COUNT =
            t.asm.Mb).apply(null, arguments)
        }),
        rn = (t._emscripten_enum_draco_StatusCode_OK = function () {
          return (rn = t._emscripten_enum_draco_StatusCode_OK = t.asm.Nb).apply(
            null,
            arguments
          )
        }),
        nn = (t._emscripten_enum_draco_StatusCode_DRACO_ERROR = function () {
          return (nn = t._emscripten_enum_draco_StatusCode_DRACO_ERROR =
            t.asm.Ob).apply(null, arguments)
        }),
        on = (t._emscripten_enum_draco_StatusCode_IO_ERROR = function () {
          return (on = t._emscripten_enum_draco_StatusCode_IO_ERROR =
            t.asm.Pb).apply(null, arguments)
        }),
        _n = (t._emscripten_enum_draco_StatusCode_INVALID_PARAMETER =
          function () {
            return (_n = t._emscripten_enum_draco_StatusCode_INVALID_PARAMETER =
              t.asm.Qb).apply(null, arguments)
          }),
